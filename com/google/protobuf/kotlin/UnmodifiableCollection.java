...
public class UnmodifiableCollection implements a, Collection, java.util.Collection {
    @l
    private final java.util.Collection delegate;

    public UnmodifiableCollection(@l java.util.Collection collection0) {
        L.p(collection0, "delegate");
        super();
        this.delegate = collection0;
    }
