...
final class ComposerKt.resetSlotsInstance.1 extends N implements p {
    public static final ComposerKt.resetSlotsInstance.1 e;

    static {
        ComposerKt.resetSlotsInstance.1.e = new ComposerKt.resetSlotsInstance.1();
    }
