...
final class RequiredMinIntrinsicHeightModifier implements IntrinsicSizeModifier {
    @l
    public static final RequiredMinIntrinsicHeightModifier a;
    private static final boolean b;

    static {
        RequiredMinIntrinsicHeightModifier.a = new RequiredMinIntrinsicHeightModifier();
    }

    @Override  // androidx.compose.foundation.layout.IntrinsicSizeModifier
    public boolean F1() {
        return RequiredMinIntrinsicHeightModifier.b;
    }
    ...
    public long u1(@l MeasureScope measureScope0, @l Measurable measurable0, long v) {
        ...
        int v1 = measurable0.D0(Constraints.p(v));
