...
public class fDm extends cr {
    public fDm(View view0, PjT pjT0) {
        super(view0, pjT0);
    }

    @Override  // com.bytedance.sdk.component.adexpress.dynamic.animation.PjT.cr
    List PjT() {
        ObjectAnimator objectAnimator0 = ObjectAnimator.ofFloat(this.ReZ, "rotation", new float[]{0.0f, ((float)this.Zh.JQp()), 0.0f, ((float)this.Zh.JQp()), 0.0f}).setDuration(((long)(((int)(this.Zh.DWo() * 1000.0)))));
