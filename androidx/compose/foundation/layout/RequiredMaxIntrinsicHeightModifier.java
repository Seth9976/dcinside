...
final class RequiredMaxIntrinsicHeightModifier implements IntrinsicSizeModifier {
    @l
    public static final RequiredMaxIntrinsicHeightModifier a;
    private static final boolean b;

    static {
        RequiredMaxIntrinsicHeightModifier.a = new RequiredMaxIntrinsicHeightModifier();
    }

    @Override  // androidx.compose.foundation.layout.IntrinsicSizeModifier
    public boolean F1() {
        return RequiredMaxIntrinsicHeightModifier.b;
    }
