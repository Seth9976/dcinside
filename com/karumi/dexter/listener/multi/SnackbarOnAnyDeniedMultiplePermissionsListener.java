...
public class SnackbarOnAnyDeniedMultiplePermissionsListener extends BaseMultiplePermissionsListener {
    ...
    private SnackbarOnAnyDeniedMultiplePermissionsListener(View view0, String s, String s1, View.OnClickListener view$OnClickListener0, a snackbar$a0, int v) {
        this.view = view0;
        this.text = s;
        this.buttonText = s1;
    ...
    SnackbarOnAnyDeniedMultiplePermissionsListener(View view0, String s, String s1, View.OnClickListener view$OnClickListener0, a snackbar$a0, int v, com.karumi.dexter.listener.multi.SnackbarOnAnyDeniedMultiplePermissionsListener.1 snackbarOnAnyDeniedMultiplePermissionsListener$10) {
    ...
    class com.karumi.dexter.listener.multi.SnackbarOnAnyDeniedMultiplePermissionsListener.1 {
    }
