...
public class b extends d {
    private static Object a(com.bykv.vk.openvk.preload.b.b b0, Pair pair0) throws Throwable {
        GeckoLogger.d("gecko-debug-tag", new Object[]{"start check patch single file, channel:", ((UpdatePackage)pair0.second).getChannel()});
        a a0 = (a)pair0.first;
        a0.b(0L);
        ...
        try {
            ...
            throw new com.bykv.vk.openvk.preload.geckox.b.b("check patch single file failed, channel:" + updatePackage0.getChannel() + ", pkg id:" + updatePackage0.getPatch().getId() + ", caused by:" + throwable0.getMessage(), throwable0);
        }
    }
