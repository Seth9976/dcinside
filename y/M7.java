...
public final class m7 implements ViewBinding {
    ...
    @NonNull
    public static m7 a(@NonNull View view0) {
                                                                                ...
                                                                                if(((ResizeTextView)view19) != null) {
                                                                                    ...
                                                                                    if(((AppCompatImageView)view20) != null) {
                                                                                        ...
                                                                                        if(((ResizeTextView)view21) != null) {
                                                                                            return new m7(((DividerConstraintLayout)view0), ((TextView)view1), ((ImageView)view2), ((ImageView)view3), ((ResizeTextView)view4), ((TextView)view5), ((ImageView)view6), ((ImageView)view7), ((TextView)view8), ((TextView)view9), ((Barrier)view10), ((TextView)view11), ((ResizeTextView)view12), ((SimpleDraweeView)view13), ((ImageView)view14), ((ResizeTextView)view15), ((AppCompatImageView)view16), ((ResizeTextView)view17), ((SimpleDraweeView)view18), ((ResizeTextView)view19), ((AppCompatImageView)view20), ((ResizeTextView)view21));
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
    ...
    @NonNull
    public static m7 c(@NonNull LayoutInflater layoutInflater0) {
        return m7.d(layoutInflater0, null, false);
    }

    @NonNull
    public static m7 d(@NonNull LayoutInflater layoutInflater0, @Nullable ViewGroup viewGroup0, boolean z) {
        View view0 = layoutInflater0.inflate(0x7F0E0263, viewGroup0, false);  // layout:view_reply_item_image
        if(z) {
