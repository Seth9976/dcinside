...
final class zzgxs extends zzgvv implements zzgxz, zzgzl, RandomAccess {
    ...
    static {
        int[] arr_v = new int[0];
        zzgxs.zza = arr_v;
        zzgxs.zzb = new zzgxs(arr_v, 0, false);
    }

    zzgxs() {
        this(zzgxs.zza, 0, true);
    }

    private zzgxs(int[] arr_v, int v, boolean z) {
        super(z);
        this.zzc = arr_v;
        this.zzd = v;
    }
        ...
        if(v >= 0) {
            ...
            if(v <= v2) {
                ...
                if(v2 < arr_v.length) {
                    ...
                    int[] arr_v1 = new int[zzgxs.zzk(arr_v.length)];
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzgxs)) {
            return super.addAll(collection0);
        }
        int v = ((zzgxs)collection0).zzd;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzd;
        ...
        System.arraycopy(((zzgxs)collection0).zzc, 0, this.zzc, this.zzd, ((zzgxs)collection0).zzd);
        this.zzd = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzgxs)) {
            return super.equals(object0);
        }
        if(this.zzd != ((zzgxs)object0).zzd) {
            return false;
        }
        int[] arr_v = ((zzgxs)object0).zzc;
    ...
    public final Object set(int v, Object object0) {
        return this.zze(v, ((int)(((Integer)object0))));
    }
    ...
    @Override  // com.google.android.gms.internal.ads.zzgxz
    public final int zze(int v, int v1) {
        this.zzdG();
        this.zzm(v);
        int[] arr_v = this.zzc;
        int v2 = arr_v[v];
    ...
    @Override  // com.google.android.gms.internal.ads.zzgxz
    public final zzgxz zzh(int v) {
        if(v < this.zzd) {
            throw new IllegalArgumentException();
        }
        return v == 0 ? new zzgxs(zzgxs.zza, this.zzd, true) : new zzgxs(Arrays.copyOf(this.zzc, v), this.zzd, true);
    }
    ...
    public final void zzi(int v) {
        ...
        if(this.zzd == v1) {
            int[] arr_v = new int[zzgxs.zzk(v1)];
