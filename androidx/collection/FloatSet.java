...
public abstract class FloatSet {
    ...
    public static String D(FloatSet floatSet0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return floatSet0.w(charSequence0, charSequence5, charSequence4, ((v1 & 8) == 0 ? v : -1), charSequence3);
    }

    public static String E(FloatSet floatSet0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function1 function10, int v1, Object object0) {
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        }
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L && !((Boolean)function10.invoke(((float)arr_f[(v1 << 3) + v4]))).booleanValue()) {
                            return false;
                        }
                        v2 >>= 8;
                    }
    ...
    public boolean equals(@m Object object0) {
        ...
        if(!(object0 instanceof FloatSet)) {
            return false;
        }
        if(((FloatSet)object0).d != this.d) {
            return false;
        }
        float[] arr_f = this.b;
        long[] arr_v = this.a;
        ...
        if(v >= 0) {
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    int v3 = 8 - (~(v1 - v) >>> 0x1F);
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L && !((FloatSet)object0).d(arr_f[(v1 << 3) + v4])) {
                            return false;
                        }
                        v2 >>= 8;
                    }
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L && ((Boolean)function10.invoke(((float)arr_f[(v1 << 3) + v5]))).booleanValue()) {
                            ++v2;
                        }
                        v3 >>= 8;
                    }
        ...
        if(v >= 0) {
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            v2 += Float.floatToIntBits(arr_f[(v1 << 3) + v5]);
                        }
                        v3 >>= 8;
                    }
                    if(v4 != 8) {
    ...
    public final float i(@l Function1 function10) {
        L.p(function10, "predicate");
        float[] arr_f = this.b;
        long[] arr_v = this.a;
        int v = arr_v.length - 2;
    ...
    public final String r() {
        return FloatSet.D(this, null, null, null, 0, null, 0x1F, null);
    }
    ...
    public final String s(@l CharSequence charSequence0) {
        L.p(charSequence0, "separator");
        return FloatSet.D(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String t(@l CharSequence charSequence0, @l CharSequence charSequence1) {
        L.p(charSequence0, "separator");
        L.p(charSequence1, "prefix");
        return FloatSet.D(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }

    @Override
    @l
    public String toString() {
        return FloatSet.D(this, null, "[", "]", 0, null, 25, null);
    }
    ...
    public final String u(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2) {
        ...
        return FloatSet.D(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String v(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2, int v) {
        ...
        L.p(charSequence1, "prefix");
        L.p(charSequence2, "postfix");
        return FloatSet.D(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
