...
public class WebpBitmapFactory {
    ...
    private static float getScaleFromOptions(BitmapFactory.Options bitmapFactory$Options0) {
        ...
        if(bitmapFactory$Options0 != null) {
            ...
            if(bitmapFactory$Options0.inScaled) {
                return bitmapFactory$Options0.inDensity == 0 || bitmapFactory$Options0.inTargetDensity == 0 || bitmapFactory$Options0.inDensity == bitmapFactory$Options0.inScreenDensity ? f : f * (((float)bitmapFactory$Options0.inTargetDensity) / ((float)bitmapFactory$Options0.inDensity));
            }
        }
        return f;
    }
    ...
    public static boolean webpSupportRequired(byte[] arr_b, int v, int v1) {
        try {
            e d$e0 = d.e(arr_b, v, v1);
            return WebpBitmapFactory.sUseSystemDecoder ? false : d.i(d$e0);
        }
        catch(IOException unused_ex) {
            return false;
        }
