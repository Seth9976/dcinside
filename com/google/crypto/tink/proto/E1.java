...
public final class e1 extends l0 implements f1 {
    static class a {
        static final int[] a;
    ...
    public static final class b extends com.google.crypto.tink.shaded.protobuf.l0.b implements f1 {
        private b() {
    ...
    private static final e1 DEFAULT_INSTANCE = null;
    ...
    protected final Object C1(i l0$i0, Object object0, Object object1) {
        switch(l0$i0) {
            ...
            case 3: {
                return l0.e2(e1.DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\f\u0002\n", new Object[]{"hash_", "salt_"});
            }
            case 4: {
                return e1.DEFAULT_INSTANCE;
            }
            case 5: {
                j1 j10 = e1.PARSER;
                if(j10 == null) {
    ...
    public static b M2() {
        return (b)e1.DEFAULT_INSTANCE.y1();
    }

    public static b N2(e1 e10) {
        return (b)e1.DEFAULT_INSTANCE.z1(e10);
    }

    public static e1 O2(InputStream inputStream0) throws IOException {
        return (e1)l0.i2(e1.DEFAULT_INSTANCE, inputStream0);
    }

    public static e1 P2(InputStream inputStream0, V v0) throws IOException {
        return (e1)l0.j2(e1.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static e1 Q2(u u0) throws y0 {
        return (e1)l0.k2(e1.DEFAULT_INSTANCE, u0);
    }

    public static e1 R2(u u0, V v0) throws y0 {
        return (e1)l0.l2(e1.DEFAULT_INSTANCE, u0, v0);
    }

    public static e1 S2(z z0) throws IOException {
        return (e1)l0.m2(e1.DEFAULT_INSTANCE, z0);
    }

    public static e1 T2(z z0, V v0) throws IOException {
        return (e1)l0.n2(e1.DEFAULT_INSTANCE, z0, v0);
    }

    public static e1 U2(InputStream inputStream0) throws IOException {
        return (e1)l0.o2(e1.DEFAULT_INSTANCE, inputStream0);
    }

    public static e1 V2(InputStream inputStream0, V v0) throws IOException {
        return (e1)l0.p2(e1.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static e1 W2(ByteBuffer byteBuffer0) throws y0 {
        return (e1)l0.q2(e1.DEFAULT_INSTANCE, byteBuffer0);
    }

    public static e1 X2(ByteBuffer byteBuffer0, V v0) throws y0 {
        return (e1)l0.r2(e1.DEFAULT_INSTANCE, byteBuffer0, v0);
    }

    public static e1 Y2(byte[] arr_b) throws y0 {
        return (e1)l0.s2(e1.DEFAULT_INSTANCE, arr_b);
    }

    public static e1 Z2(byte[] arr_b, V v0) throws y0 {
        return (e1)l0.t2(e1.DEFAULT_INSTANCE, arr_b, v0);
    }

    public static j1 a3() {
        return e1.DEFAULT_INSTANCE.getParserForType();
    }
