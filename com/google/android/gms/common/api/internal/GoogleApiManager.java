...
public class GoogleApiManager implements Handler.Callback {
    ...
    public final boolean handleMessage(@NonNull Message message0) {
        ...
        switch(v) {
            ...
            case 5: {
                ...
                if(zabq0 != null) {
                    if(connectionResult1.getErrorCode() == 13) {
                        zabq0.zaE(new Status(17, "Error resolution was canceled by the user, original error message: " + this.zaj.getErrorString(connectionResult1.getErrorCode()) + ": " + connectionResult1.getErrorMessage()));
                        return true;
                    }
                    zabq0.zaE(GoogleApiManager.zaF(zabq0.zad, connectionResult1));
                    return true;
                }
            ...
            case 13: {
                ...
                zabq zabq2 = (zabq)this.zan.get(zach0.zac.getApiKey());
                if(zabq2 == null) {
            ...
            case 14: {
                ...
                ApiKey apiKey1 = zaaf0.zaa();
                if(!this.zan.containsKey(apiKey1)) {
                    zaaf0.zab().setResult(Boolean.FALSE);
                    return true;
                }
                zaaf0.zab().setResult(Boolean.valueOf(zabq.zay(((zabq)this.zan.get(apiKey1)), false)));
                return true;
            }
            case 15: {
                zabs zabs0 = (zabs)message0.obj;
                if(this.zan.containsKey(zabs0.zaa)) {
                    zabq.zal(((zabq)this.zan.get(zabs0.zaa)), zabs0);
                    return true;
                }
                break;
            }
            case 16: {
                ...
                if(this.zan.containsKey(zabs1.zaa)) {
                    zabq.zam(((zabq)this.zan.get(zabs1.zaa)), zabs1);
                    return true;
                }
                break;
            }
    ...
    public final void zaA(@NonNull zaae zaae0) {
        synchronized(GoogleApiManager.zac) {
            if(this.zao != zaae0) {
                this.zao = zaae0;
                this.zap.clear();
    ...
    final void zaB(@NonNull zaae zaae0) {
        synchronized(GoogleApiManager.zac) {
            if(this.zao == zaae0) {
                this.zao = null;
                this.zap.clear();
    ...
    final boolean zaE(ConnectionResult connectionResult0, int v) {
    ...
    private static Status zaF(ApiKey apiKey0, ConnectionResult connectionResult0) {
        return new Status(connectionResult0, "API: " + apiKey0.zaa() + " is not available on this device. Connection failed with: " + connectionResult0);
    }
    ...
    @NonNull
    @ResultIgnorabilityUnspecified
    public static GoogleApiManager zak(@NonNull Context context0) {
        synchronized(GoogleApiManager.zac) {
    ...
    @NonNull
    public final Task zam(@NonNull Iterable iterable0) {
    ...
    @NonNull
    @ResultIgnorabilityUnspecified
    public final Task zan(@NonNull GoogleApi googleApi0) {
    ...
    @NonNull
    public final Task zao(@NonNull GoogleApi googleApi0, @NonNull RegisterListenerMethod registerListenerMethod0, @NonNull UnregisterListenerMethod unregisterListenerMethod0, @NonNull Runnable runnable0) {
    ...
    @NonNull
    public final Task zap(@NonNull GoogleApi googleApi0, @NonNull ListenerKey listenerHolder$ListenerKey0, int v) {
        TaskCompletionSource taskCompletionSource0 = new TaskCompletionSource();
    ...
    static void zat(GoogleApiManager googleApiManager0, boolean z) {
        googleApiManager0.zaf = true;
    }

    public final void zau(@NonNull GoogleApi googleApi0, int v, @NonNull ApiMethodImpl baseImplementation$ApiMethodImpl0) {
    ...
    public final void zav(@NonNull GoogleApi googleApi0, int v, @NonNull TaskApiCall taskApiCall0, @NonNull TaskCompletionSource taskCompletionSource0, @NonNull StatusExceptionMapper statusExceptionMapper0) {
    ...
    final void zaw(MethodInvocation methodInvocation0, int v, long v1, int v2) {
        zace zace0 = new zace(methodInvocation0, v, v1, v2);
        Message message0 = this.zar.obtainMessage(18, zace0);
        this.zar.sendMessage(message0);
    }

    public final void zax(@NonNull ConnectionResult connectionResult0, int v) {
    ...
    public final void zaz(@NonNull GoogleApi googleApi0) {
