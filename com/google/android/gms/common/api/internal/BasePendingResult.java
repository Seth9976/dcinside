...
public abstract class BasePendingResult extends PendingResult {
    ...
    @KeepForSdk
    @Deprecated
    protected BasePendingResult(@NonNull Looper looper0) {
        this.zae = new Object();
        this.zaf = new CountDownLatch(1);
        this.zag = new ArrayList();
        this.zai = new AtomicReference();
    ...
    @KeepForSdk
    protected BasePendingResult(@Nullable GoogleApiClient googleApiClient0) {
        this.zae = new Object();
        this.zaf = new CountDownLatch(1);
        this.zag = new ArrayList();
        this.zai = new AtomicReference();
    ...
    @VisibleForTesting
    @KeepForSdk
    protected BasePendingResult(@NonNull CallbackHandler basePendingResult$CallbackHandler0) {
        this.zae = new Object();
        this.zaf = new CountDownLatch(1);
        this.zag = new ArrayList();
        this.zai = new AtomicReference();
    ...
    @NonNull
    @KeepForSdk
    protected abstract Result createFailedResult(@NonNull Status arg1);
    ...
    @KeepForSdk
    protected final void setCancelToken(@NonNull ICancelToken iCancelToken0) {
        synchronized(this.zae) {
    ...
    public final void zan(@Nullable zadb zadb0) {
        this.zai.set(zadb0);
    }
}
