...
public final class b1 extends l0 implements c1 {
    static class a {
        static final int[] a;
    ...
    public static final class b extends com.google.crypto.tink.shaded.protobuf.l0.b implements c1 {
        private b() {
    ...
    private static final b1 DEFAULT_INSTANCE = null;
    ...
    protected final Object C1(i l0$i0, Object object0, Object object1) {
        switch(l0$i0) {
            ...
            case 3: {
                return l0.e2(b1.DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\t\u0002\u000B\u0003\u000B", new Object[]{"params_", "keySize_", "version_"});
            }
            case 4: {
    ...
    public static b Q2() {
        return (b)b1.DEFAULT_INSTANCE.y1();
    }

    public static b R2(b1 b10) {
        return (b)b1.DEFAULT_INSTANCE.z1(b10);
    }

    public static b1 S2(InputStream inputStream0) throws IOException {
        return (b1)l0.i2(b1.DEFAULT_INSTANCE, inputStream0);
    }

    public static b1 T2(InputStream inputStream0, V v0) throws IOException {
        return (b1)l0.j2(b1.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static b1 U2(u u0) throws y0 {
        return (b1)l0.k2(b1.DEFAULT_INSTANCE, u0);
    }

    public static b1 V2(u u0, V v0) throws y0 {
        return (b1)l0.l2(b1.DEFAULT_INSTANCE, u0, v0);
    }

    public static b1 W2(z z0) throws IOException {
        return (b1)l0.m2(b1.DEFAULT_INSTANCE, z0);
    }

    public static b1 X2(z z0, V v0) throws IOException {
        return (b1)l0.n2(b1.DEFAULT_INSTANCE, z0, v0);
    }

    public static b1 Y2(InputStream inputStream0) throws IOException {
        return (b1)l0.o2(b1.DEFAULT_INSTANCE, inputStream0);
    }

    public static b1 Z2(InputStream inputStream0, V v0) throws IOException {
        return (b1)l0.p2(b1.DEFAULT_INSTANCE, inputStream0, v0);
    }
    ...
    public static b1 a3(ByteBuffer byteBuffer0) throws y0 {
        return (b1)l0.q2(b1.DEFAULT_INSTANCE, byteBuffer0);
    }
    ...
    public static b1 b3(ByteBuffer byteBuffer0, V v0) throws y0 {
        return (b1)l0.r2(b1.DEFAULT_INSTANCE, byteBuffer0, v0);
    }

    public static b1 c3(byte[] arr_b) throws y0 {
        return (b1)l0.s2(b1.DEFAULT_INSTANCE, arr_b);
    }
    ...
    public static b1 d3(byte[] arr_b, V v0) throws y0 {
        return (b1)l0.t2(b1.DEFAULT_INSTANCE, arr_b, v0);
    }

    public static j1 e3() {
        return b1.DEFAULT_INSTANCE.getParserForType();
    }
