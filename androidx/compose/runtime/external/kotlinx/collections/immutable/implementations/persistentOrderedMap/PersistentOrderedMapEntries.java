...
public final class PersistentOrderedMapEntries extends i implements ImmutableSet {
    @l
    private final PersistentOrderedMap b;

    public PersistentOrderedMapEntries(@l PersistentOrderedMap persistentOrderedMap0) {
    ...
    public Iterator iterator() {
        return new PersistentOrderedMapEntriesIterator(this.b);
    }
}
