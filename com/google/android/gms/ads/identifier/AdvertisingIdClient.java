...
public class AdvertisingIdClient {
    ...
    public static Info getAdvertisingIdInfo(@NonNull Context context0) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        try {
            Info advertisingIdClient$Info0 = advertisingIdClient0.zzf(-1);
            long v2 = SystemClock.elapsedRealtime() - v1;
            advertisingIdClient0.zze(advertisingIdClient$Info0, true, 0.0f, v2, "", null);
            zzd0.zzc(35401, 0, v1, System.currentTimeMillis(), ((int)(SystemClock.elapsedRealtime() - v1)));
            Log.i("AdvertisingIdClient", "GetInfoInternal elapse " + v2 + "ms");
            return advertisingIdClient$Info0;
        }
        catch(Throwable throwable0) {
            advertisingIdClient0.zze(null, true, 0.0f, -1L, "", throwable0);
            ...
            zzd0.zzc(35401, v3, v1, System.currentTimeMillis(), ((int)(SystemClock.elapsedRealtime() - v1)));
            throw throwable0;
        }
    }
    ...
    @VisibleForTesting
    final void zzd() throws IOException {
        synchronized(this) {
            if(!this.zzc) {
                try {
    ...
    @VisibleForTesting
    final boolean zze(@Nullable Info advertisingIdClient$Info0, boolean z, float f, long v, String s, @Nullable Throwable throwable0) {
        if(Math.random() <= 0.0) {
    ...
    private final Info zzf(int v) throws IOException {
