...
public final class AppCompatToggleButton.InspectionCompanion implements InspectionCompanion {
    ...
    public void a(@NonNull AppCompatToggleButton appCompatToggleButton0, @NonNull PropertyReader propertyReader0) {
        if(!this.a) {
            throw e.a();
        }
        propertyReader0.readObject(this.b, appCompatToggleButton0.getBackgroundTintList());
        propertyReader0.readObject(this.c, appCompatToggleButton0.getBackgroundTintMode());
        propertyReader0.readObject(this.d, appCompatToggleButton0.getCompoundDrawableTintList());
        propertyReader0.readObject(this.e, appCompatToggleButton0.getCompoundDrawableTintMode());
    }
    ...
    public void readProperties(@NonNull Object object0, @NonNull PropertyReader propertyReader0) {
        this.a(((AppCompatToggleButton)object0), propertyReader0);
    }
}
