...
public abstract class IntList {
    ...
    private IntList(int v) {
        this.a = v == 0 ? IntSetKt.b() : new int[v];
    }

    public IntList(int v, w w0) {
        this(v);
    }
    ...
    public final String D() {
        return IntList.P(this, null, null, null, 0, null, 0x1F, null);
    }
    ...
    public final String E(@l CharSequence charSequence0) {
        ...
        return IntList.P(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String F(@l CharSequence charSequence0, @l CharSequence charSequence1) {
        ...
        return IntList.P(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String G(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2) {
        ...
        return IntList.P(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String H(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2, int v) {
        ...
        L.p(charSequence1, "prefix");
        L.p(charSequence2, "postfix");
        return IntList.P(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
    ...
    public static String P(IntList intList0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return intList0.I(charSequence0, charSequence5, charSequence4, ((v1 & 8) == 0 ? v : -1), charSequence3);
    }

    public static String Q(IntList intList0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function1 function10, int v1, Object object0) {
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        }
        if((v1 & 1) != 0) {
    ...
    public final int S(@l Function1 function10) {
        L.p(function10, "predicate");
        int[] arr_v = this.a;
        for(int v = this.b - 1; -1 < v; --v) {
            int v1 = arr_v[v];
    ...
    public final boolean d(@l IntList intList0) {
        L.p(intList0, "elements");
        kotlin.ranges.l l0 = s.W1(0, intList0.b);
        int v = l0.g();
        int v1 = l0.h();
        if(v <= v1) {
            while(true) {
                if(!this.c(intList0.s(v))) {
                    return false;
                }
                if(v == v1) {
                    break;
    ...
    public boolean equals(@m Object object0) {
        if(object0 instanceof IntList) {
            int v = this.b;
            if(((IntList)object0).b == v) {
                int[] arr_v = this.a;
                int[] arr_v1 = ((IntList)object0).a;
    ...
    public final int g(@IntRange(from = 0L) int v) {
        if(v < 0 || v >= this.b) {
    ...
    public final int h(@IntRange(from = 0L) int v, @l Function1 function10) {
        L.p(function10, "defaultValue");
        return v < 0 || v >= this.b ? ((Number)function10.invoke(v)).intValue() : this.a[v];
    }
    ...
    public final Object k(Object object0, @l o o0) {
        ...
        int v = this.b;
        for(int v1 = 0; v1 < v; ++v1) {
            object0 = o0.invoke(object0, ((int)arr_v[v1]));
        }
        return object0;
    }
    ...
    public final Object l(Object object0, @l p p0) {
        ...
        int v = this.b;
        for(int v1 = 0; v1 < v; ++v1) {
            object0 = p0.invoke(v1, object0, ((int)arr_v[v1]));
        }
        return object0;
    }
    ...
    public final void r(@l o o0) {
        ...
        int[] arr_v = this.a;
        for(int v = this.b - 1; -1 < v; --v) {
            o0.invoke(v, ((int)arr_v[v]));
        }
    }

    public final int s(@IntRange(from = 0L) int v) {
        if(v < 0 || v >= this.b) {
            throw new IndexOutOfBoundsException("Index " + v + " must be in 0.." + (this.b - 1));
        }
        return this.a[v];
    ...
    public String toString() {
        return IntList.P(this, null, "[", "]", 0, null, 25, null);
    }
