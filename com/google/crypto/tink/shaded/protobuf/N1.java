...
final class n1 extends c implements RandomAccess {
    private Object[] c;
    private int d;
    private static final n1 e;

    static {
        n1 n10 = new n1(new Object[0], 0);
        n1.e = n10;
        n10.makeImmutable();
    }
    ...
    private n1(Object[] arr_object, int v) {
        this.c = arr_object;
        this.d = v;
    }
        ...
        if(v >= 0) {
            ...
            if(v <= v1) {
                ...
                if(v1 < arr_object.length) {
                    ...
                    Object[] arr_object1 = n1.b(v1 * 3 / 2 + 1);
    ...
    public n1 h(int v) {
        ...
        return new n1(Arrays.copyOf(this.c, v), this.d);
    }
