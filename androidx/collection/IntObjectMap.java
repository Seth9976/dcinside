...
public abstract class IntObjectMap {
    ...
    public final String B(@l CharSequence charSequence0) {
        ...
        return IntObjectMap.L(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String D(@l CharSequence charSequence0, @l CharSequence charSequence1) {
        ...
        return IntObjectMap.L(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String F(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2) {
        ...
        return IntObjectMap.L(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String G(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2, int v) {
        ...
        L.p(charSequence1, "prefix");
        L.p(charSequence2, "postfix");
        return IntObjectMap.L(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
    ...
    public static String L(IntObjectMap intObjectMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return intObjectMap0.I(charSequence0, charSequence5, charSequence4, ((v1 & 8) == 0 ? v : -1), charSequence3);
    }

    public static String M(IntObjectMap intObjectMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, o o0, int v1, Object object0) {
        long[] arr_v3;
        long[] arr_v2;
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        int[] arr_v = intObjectMap0.b;
        Object[] arr_object = intObjectMap0.c;
        long[] arr_v1 = intObjectMap0.a;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(!((Boolean)o0.invoke(((int)arr_v[v5]), arr_object[v5])).booleanValue()) {
                                return false;
                            }
                        }
                        v2 >>= 8;
    ...
    public boolean equals(@m Object object0) {
        ...
        if(((IntObjectMap)object0).t() != this.t()) {
            return false;
        }
        int[] arr_v = this.b;
        Object[] arr_object = this.c;
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            ...
                            if(object1 == null) {
                                if(((IntObjectMap)object0).n(v6) != null || !((IntObjectMap)object0).e(v6)) {
                                    return false;
                                }
                            }
                            else if(!L.g(object1, ((IntObjectMap)object0).n(v6))) {
                                return false;
                            }
                        }
                        v2 >>= 8;
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            if(((Boolean)o0.invoke(((int)arr_v[v6]), arr_object[v6])).booleanValue()) {
                                ++v2;
                            }
                        }
                        v3 >>= 8;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            o0.invoke(((int)arr_v[v5]), arr_object[v5]);
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final Object r(int v, Object object0) {
        int v1 = 0xCC9E2D51 * v ^ 0xCC9E2D51 * v << 16;
        int v2 = this.d;
        int v3 = v1 >>> 7 & v2;
        int v4 = 0;
    ...
    public final Object s(int v, @l a a0) {
        L.p(a0, "defaultValue");
    ...
    public final String z() {
        return IntObjectMap.L(this, null, null, null, 0, null, 0x1F, null);
    }
}
