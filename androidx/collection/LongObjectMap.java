...
public abstract class LongObjectMap {
    @l
    @f
    public long[] a;
    @l
            ...
            while(true) {
                ...
                while(v5 < v4) {
                    if((v3 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)o0.invoke(v7, object0)));
                        ++v2;
                    }
                    v3 >>= 8;
                    ++v5;
    ...
    public final String B(@l CharSequence charSequence0) {
        ...
        return LongObjectMap.L(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String D(@l CharSequence charSequence0, @l CharSequence charSequence1) {
        ...
        return LongObjectMap.L(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String F(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2) {
        ...
        return LongObjectMap.L(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String G(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2, int v) {
        ...
        L.p(charSequence1, "prefix");
        L.p(charSequence2, "postfix");
        return LongObjectMap.L(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
            ...
            while(true) {
                ...
                while(v6 < v5) {
                    if((v4 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)o0.invoke(v8, object0)));
                        ++v3;
                    }
                    v4 >>= 8;
                    ++v6;
            ...
            while(true) {
                ...
                while(v7 < v6) {
                    if((v4 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)o0.invoke(v9, object0)));
                        ++v3;
                    }
                    else {
                        arr_v2 = arr_v;
    ...
    public static String L(LongObjectMap longObjectMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return longObjectMap0.I(charSequence0, charSequence5, charSequence4, ((v1 & 8) == 0 ? v : -1), charSequence3);
    }

    public static String M(LongObjectMap longObjectMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, o o0, int v1, Object object0) {
        long[] arr_v3;
        long[] arr_v2;
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        long[] arr_v = longObjectMap0.b;
        Object[] arr_object = longObjectMap0.c;
        long[] arr_v1 = longObjectMap0.a;
            ...
            while(true) {
                ...
                while(v8 < v7) {
                    if((v5 & 0xFFL) < 0x80L) {
                        ...
                        arr_v2 = arr_v1;
                        stringBuilder0.append(((CharSequence)o0.invoke(v10, object1)));
                        ++v4;
                    }
                    else {
                        arr_v2 = arr_v1;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(!((Boolean)o0.invoke(((long)arr_v[v5]), arr_object[v5])).booleanValue()) {
                                return false;
                            }
                        }
                        v2 >>= 8;
    ...
    public boolean equals(@m Object object0) {
        ...
        if(((LongObjectMap)object0).t() != this.t()) {
            return false;
        }
        long[] arr_v = this.b;
        Object[] arr_object = this.c;
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; v4 = v6 + 1) {
                        if((0xFFL & v2) < 0x80L) {
                            ...
                            if(object1 == null) {
                                if(((LongObjectMap)object0).n(v7) != null || !((LongObjectMap)object0).e(v7)) {
                                    return false;
                                }
                            }
                            else if(!L.g(object1, ((LongObjectMap)object0).n(v7))) {
                                return false;
                            }
                        }
                        else {
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            if(((Boolean)o0.invoke(((long)arr_v[v6]), arr_object[v6])).booleanValue()) {
                                ++v2;
                            }
                        }
                        v3 >>= 8;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            o0.invoke(((long)arr_v[v5]), arr_object[v5]);
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final Object r(long v, Object object0) {
        int v1 = (int)(v ^ v >>> 0x20);
        int v2 = v1 * 0xCC9E2D51 ^ v1 * 0xCC9E2D51 << 16;
        int v3 = this.d;
        int v4 = v2 >>> 7 & v3;
        ...
        while(true) {
            ...
            for(long v9 = ~v8 & v8 - 0x101010101010101L & 0x8080808080808080L; v9 != 0L; v9 &= v9 - 1L) {
                int v10 = (Long.numberOfTrailingZeros(v9) >> 3) + v4 & v3;
                if(this.b[v10] == v) {
                    return v10 < 0 ? object0 : this.c[v10];
                }
            }
            if((v7 & ~v7 << 6 & 0x8080808080808080L) != 0L) {
                throw new ArrayIndexOutOfBoundsException(-1);
    ...
    public final Object s(long v, @l a a0) {
        L.p(a0, "defaultValue");
    ...
    public final String z() {
        return LongObjectMap.L(this, null, null, null, 0, null, 0x1F, null);
    }
}
