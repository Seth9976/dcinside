...
public final class Banner480x320ScaleView extends BaseBannerView {
    @l
    ...
    @j
    public Banner480x320ScaleView(@l Context context0) {
        L.p(context0, "context");
        this(context0, null, 0, 6, null);
    }

    @j
    public Banner480x320ScaleView(@l Context context0, @m AttributeSet attributeSet0) {
        L.p(context0, "context");
        this(context0, attributeSet0, 0, 4, null);
    }

    @j
    public Banner480x320ScaleView(@l Context context0, @m AttributeSet attributeSet0, int v) {
        L.p(context0, "context");
        super(context0, attributeSet0, v);
        this.f = (float)d.b(context0, 320);
        this.g = (float)d.b(context0, 480);
        this.setId(id.ads_banner_background);
        View.inflate(context0, layout.ads_view_banner_480x320, this);
    ...
    public Banner480x320ScaleView(Context context0, AttributeSet attributeSet0, int v, int v1, w w0) {
        if((v1 & 2) != 0) {
            attributeSet0 = null;
        }
        if((v1 & 4) != 0) {
    ...
    protected void onSizeChanged(int v, int v1, int v2, int v3) {
        ...
        float f = ((float)v) / ((float)v1) > this.g / this.f ? ((float)v1) / this.f : ((float)v) / this.g;
        this.e.setScaleX(f);
        this.e.setScaleY(f);
        View view0 = this.h;
        if(view0 != null) {
