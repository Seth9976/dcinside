...
public abstract class ObjectFloatMap {
            ...
            while(true) {
                ...
                while(v5 < v4) {
                    if((v3 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)o0.invoke(object0, f)));
                        ++v2;
                    }
                    v3 >>= 8;
                    ++v5;
    ...
    public final String B(@l CharSequence charSequence0) {
        ...
        return ObjectFloatMap.L(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String D(@l CharSequence charSequence0, @l CharSequence charSequence1) {
        ...
        return ObjectFloatMap.L(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String F(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2) {
        ...
        return ObjectFloatMap.L(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String G(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2, int v) {
        ...
        L.p(charSequence1, "prefix");
        L.p(charSequence2, "postfix");
        return ObjectFloatMap.L(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
    ...
    public static String L(ObjectFloatMap objectFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return objectFloatMap0.I(charSequence0, charSequence5, charSequence4, ((v1 & 8) == 0 ? v : -1), charSequence3);
    }

    public static String M(ObjectFloatMap objectFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, o o0, int v1, Object object0) {
        long[] arr_v2;
        long[] arr_v1;
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        Object[] arr_object = objectFloatMap0.b;
        float[] arr_f = objectFloatMap0.c;
        long[] arr_v = objectFloatMap0.a;
            ...
            while(true) {
                ...
                while(v8 < v7) {
                    if((v5 & 0xFFL) < 0x80L) {
                        ...
                        arr_v1 = arr_v;
                        stringBuilder0.append(((CharSequence)o0.invoke(object1, f)));
                        ++v4;
                    }
                    else {
                        arr_v1 = arr_v;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(!((Boolean)o0.invoke(arr_object[v5], ((float)arr_f[v5]))).booleanValue()) {
                                return false;
                            }
                        }
                        v2 >>= 8;
    ...
    public boolean equals(@m Object object0) {
        ...
        if(((ObjectFloatMap)object0).t() != this.t()) {
            return false;
        }
        Object[] arr_object = this.b;
        float[] arr_f = this.c;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(arr_f[v5] != ((ObjectFloatMap)object0).n(arr_object[v5])) {
                                return false;
                            }
                        }
                        v2 >>= 8;
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            if(((Boolean)o0.invoke(arr_object[v6], ((float)arr_f[v6]))).booleanValue()) {
                                ++v2;
                            }
                        }
                        v3 >>= 8;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            o0.invoke(arr_object[v5], ((float)arr_f[v5]));
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final float n(Object object0) {
    ...
    public final float r(Object object0, float f) {
        int v = this.i(object0);
        return v < 0 ? f : this.c[v];
    }

    public final float s(Object object0, @l a a0) {
        L.p(a0, "defaultValue");
        int v = this.i(object0);
        return v < 0 ? ((Number)a0.invoke()).floatValue() : this.c[v];
    }
    ...
    public final String z() {
        return ObjectFloatMap.L(this, null, null, null, 0, null, 0x1F, null);
    }
}
