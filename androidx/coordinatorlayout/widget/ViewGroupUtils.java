...
public class ViewGroupUtils {
    ...
    static {
        ViewGroupUtils.a = new ThreadLocal();
        ViewGroupUtils.b = new ThreadLocal();
    }

    public static void a(ViewGroup viewGroup0, View view0, Rect rect0) {
        rect0.set(0, 0, view0.getWidth(), view0.getHeight());
        ViewGroupUtils.c(viewGroup0, view0, rect0);
    }

    private static void b(ViewParent viewParent0, View view0, Matrix matrix0) {
        ViewParent viewParent1 = view0.getParent();
        if(viewParent1 instanceof View && viewParent1 != viewParent0) {
            ViewGroupUtils.b(viewParent0, ((View)viewParent1), matrix0);
    ...
    static void c(ViewGroup viewGroup0, View view0, Rect rect0) {
        ThreadLocal threadLocal0 = ViewGroupUtils.a;
        ...
        ViewGroupUtils.b(viewGroup0, view0, matrix0);
        ThreadLocal threadLocal1 = ViewGroupUtils.b;
