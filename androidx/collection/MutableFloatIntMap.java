...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    public MutableFloatIntMap(int v, int v1, w w0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final int S(float f, @y4.l a a0) {
        L.p(a0, "defaultValue");
        int v = this.i(f);
        if(v < 0) {
    ...
    public final void a0(@y4.l FloatIntMap floatIntMap0) {
        L.p(floatIntMap0, "from");
        this.d0(floatIntMap0);
    }

    public final int b0(float f, int v, int v1) {
        int v2 = this.R(f);
        if(v2 < 0) {
            v2 = ~v2;
        }
    ...
    public final void c0(float f, int v) {
        this.k0(f, v);
    }

    public final void d0(@y4.l FloatIntMap floatIntMap0) {
        L.p(floatIntMap0, "from");
    ...
    public final boolean f0(float f, int v) {
        int v1 = this.i(f);
        if(v1 >= 0 && this.c[v1] == v) {
            this.i0(v1);
            return true;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)o0.invoke(((float)this.b[v5]), ((int)this.c[v5]))).booleanValue()) {
                                this.i0(v5);
                            }
                        }
                        v2 >>= 8;
    ...
    public final void k0(float f, int v) {
        int v1 = this.R(f);
        if(v1 < 0) {
            v1 = ~v1;
        }
