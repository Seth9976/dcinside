...
public final class AdsPlacementFrameLayout extends FrameLayout implements AdsWidgetPlacement {
    @m
    ...
    @j
    public AdsPlacementFrameLayout(@l Context context0) {
        L.p(context0, "context");
        this(context0, null, 0, 6, null);
    }

    @j
    public AdsPlacementFrameLayout(@l Context context0, @m AttributeSet attributeSet0) {
        L.p(context0, "context");
        this(context0, attributeSet0, 0, 4, null);
    }

    @j
    public AdsPlacementFrameLayout(@l Context context0, @m AttributeSet attributeSet0, int v) {
        L.p(context0, "context");
    ...
    public AdsPlacementFrameLayout(Context context0, AttributeSet attributeSet0, int v, int v1, w w0) {
        if((v1 & 2) != 0) {
            attributeSet0 = null;
        }
        if((v1 & 4) != 0) {
    ...
    protected void onFinishInflate() {
        ...
        q.f(this, false, new Function1() {
            {
                AdsPlacementFrameLayout.this = adsPlacementFrameLayout0;
                super(1);
            }
            ...
            public final p invoke(@l View view0) {
                ...
                if(view0 instanceof AdsWidgetProduct) {
                    AdsPlacementFrameLayout.this.products.add(view0);
                    return p.c;
                }
                if(view0 instanceof AdsWidgetPlacement) {
                    AdsPlacementFrameLayout.this.placements.add(view0);
                    return p.c;
                }
                return p.a;
            }
