...
public final class zaaa extends Button {
    public zaaa(Context context0, @Nullable AttributeSet attributeSet0) {
    ...
    public final void zaa(Resources resources0, int v, int v1) {
        ...
        Drawable drawable0 = DrawableCompat.r(resources0.getDrawable(v3));
        DrawableCompat.o(drawable0, resources0.getColorStateList(color.common_google_signin_btn_tint));
        DrawableCompat.p(drawable0, PorterDuff.Mode.SRC_ATOP);
