...
public class f {
    ...
    protected f() {
        this(new g(), new pl.droidsonroids.relinker.a());
    }
    ...
    protected void b(Context context0, String s, String s1) {
        class pl.droidsonroids.relinker.f.b implements FilenameFilter {
            final String a;
            final f b;

            pl.droidsonroids.relinker.f.b(String s) {
                this.a = s;
                super();
            }
        ...
        File[] arr_file = file0.listFiles(new pl.droidsonroids.relinker.f.b(this, this.b.e(s)));
        if(arr_file == null) {
            return;
        }
    ...
    public void f(Context context0, String s) {
        this.h(context0, s, null, null);
    }

    public void g(Context context0, String s, String s1) {
        this.h(context0, s, s1, null);
    }

    public void h(Context context0, String s, String s1, c e$c0) {
        class pl.droidsonroids.relinker.f.a implements Runnable {
            final Context a;
            final String b;
            final String c;
            final c d;
            ...
            pl.droidsonroids.relinker.f.a(Context context0, String s, String s1, c e$c0) {
                this.a = context0;
                this.b = s;
                this.c = s1;
                this.d = e$c0;
            ...
            public void run() {
                ...
                catch(pl.droidsonroids.relinker.c c0) {
                    this.d.a(c0);
                }
            }
        }
        ...
        new Thread(new pl.droidsonroids.relinker.f.a(this, context0, s, s1, e$c0)).start();
    }

    public void i(Context context0, String s, c e$c0) {
        this.h(context0, s, null, e$c0);
    }

    private void j(Context context0, String s, String s1) {
        pl.droidsonroids.relinker.elf.f f0;
        ...
        try {
            ...
            if(this.e) {
                try {
                    f0 = new pl.droidsonroids.relinker.elf.f(file0);
                    List list0 = f0.c();
