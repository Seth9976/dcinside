...
public final class MutableObjectLongMap extends ObjectLongMap {
    ...
    public MutableObjectLongMap(int v, int v1, w w0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final long S(Object object0, @y4.l a a0) {
        L.p(a0, "defaultValue");
    ...
    public final void b0(@y4.l ObjectLongMap objectLongMap0) {
        L.p(objectLongMap0, "from");
        this.e0(objectLongMap0);
    }

    public final long c0(Object object0, long v, long v1) {
    ...
    public final void d0(Object object0, long v) {
        this.l0(object0, v);
    }

    public final void e0(@y4.l ObjectLongMap objectLongMap0) {
        L.p(objectLongMap0, "from");
    ...
    public final boolean g0(Object object0, long v) {
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)o0.invoke(this.b[v5], ((long)this.c[v5]))).booleanValue()) {
                                this.j0(v5);
                            }
                        }
                        v2 >>= 8;
    ...
    public final void l0(Object object0, long v) {
