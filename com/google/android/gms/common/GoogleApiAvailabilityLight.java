...
public class GoogleApiAvailabilityLight {
    ...
    public Intent getErrorResolutionIntent(@Nullable Context context0, int v, @Nullable String s) {
        switch(v) {
            ...
            case 2: {
                ...
                stringBuilder0.append("-");
                if(context0 != null) {
                    stringBuilder0.append("com.dcinside.app.android");
                }
                stringBuilder0.append("-");
                if(context0 != null) {
                    try {
                        stringBuilder0.append(Wrappers.packageManager(context0).getPackageInfo("com.dcinside.app.android", 0).versionCode);
                    }
    ...
    public PendingIntent getErrorResolutionPendingIntent(@NonNull Context context0, int v, int v1, @Nullable String s) {
        ...
        return intent0 == null ? null : PendingIntentCompat.e(context0, v1, intent0, 0x8000000, false);
    }
