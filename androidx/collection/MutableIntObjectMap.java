...
public final class MutableIntObjectMap extends IntObjectMap {
    ...
    public MutableIntObjectMap(int v) {
        super(null);
        if(v < 0) {
    ...
    public MutableIntObjectMap(int v, int v1, w w0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final Object S(int v, @y4.l a a0) {
        L.p(a0, "defaultValue");
    ...
    public final void X(@y4.l IntList intList0) {
        L.p(intList0, "keys");
    ...
    public final void Y(@y4.l IntSet intSet0) {
        L.p(intSet0, "keys");
        int[] arr_v = intSet0.b;
    ...
    public final void Z(@y4.l int[] arr_v) {
        L.p(arr_v, "keys");
    ...
    public final void a0(@y4.l IntObjectMap intObjectMap0) {
        L.p(intObjectMap0, "from");
        this.c0(intObjectMap0);
    }

    @m
    public final Object b0(int v, Object object0) {
        int v1 = this.Q(v);
    ...
    public final void c0(@y4.l IntObjectMap intObjectMap0) {
        L.p(intObjectMap0, "from");
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            this.j0(arr_v[v5], arr_object[v5]);
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final boolean e0(int v, Object object0) {
        int v10;
        int v1 = 0xCC9E2D51 * v ^ 0xCC9E2D51 * v << 16;
        int v2 = this.d;
        int v3 = v1 >>> 7 & v2;
        ...
        label_17:
            if(v10 >= 0 && L.g(this.c[v10], object0)) {
                this.h0(v10);
                return true;
            }
            return false;
    ...
    public final void g0(@y4.l o o0) {
        L.p(o0, "predicate");
        long[] arr_v = this.a;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)o0.invoke(((int)this.b[v5]), this.c[v5])).booleanValue()) {
                                this.h0(v5);
                            }
                        }
                        v2 >>= 8;
    ...
    public final void j0(int v, Object object0) {
        int v1 = this.Q(v);
        this.b[v1] = v;
        this.c[v1] = object0;
    }
    ...
    private final void l0(int v, long v1) {
        long[] arr_v = this.a;
        int v2 = (v & 7) << 3;
