...
public final class h1 extends l0 implements k1 {
    static class a {
        static final int[] a;
    ...
    public static final class b extends com.google.crypto.tink.shaded.protobuf.l0.b implements k1 {
        private b() {
        ...
        @Override  // com.google.crypto.tink.proto.k1
        public l1 a() {
            return ((h1)this.b).a();
        }
    ...
    protected final Object C1(i l0$i0, Object object0, Object object1) {
        switch(l0$i0) {
            ...
            case 3: {
                return l0.e2(h1.DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\u000B\u0002\t\u0003\n", new Object[]{"version_", "params_", "keyValue_"});
            }
            case 4: {
    ...
    public static b R2(h1 h10) {
        return (b)h1.DEFAULT_INSTANCE.z1(h10);
    }

    public static h1 S2(InputStream inputStream0) throws IOException {
        return (h1)l0.i2(h1.DEFAULT_INSTANCE, inputStream0);
    }

    public static h1 T2(InputStream inputStream0, V v0) throws IOException {
        return (h1)l0.j2(h1.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static h1 U2(u u0) throws y0 {
        return (h1)l0.k2(h1.DEFAULT_INSTANCE, u0);
    }

    public static h1 V2(u u0, V v0) throws y0 {
        return (h1)l0.l2(h1.DEFAULT_INSTANCE, u0, v0);
    }

    public static h1 W2(z z0) throws IOException {
        return (h1)l0.m2(h1.DEFAULT_INSTANCE, z0);
    }

    public static h1 X2(z z0, V v0) throws IOException {
        return (h1)l0.n2(h1.DEFAULT_INSTANCE, z0, v0);
    }

    public static h1 Y2(InputStream inputStream0) throws IOException {
        return (h1)l0.o2(h1.DEFAULT_INSTANCE, inputStream0);
    }

    public static h1 Z2(InputStream inputStream0, V v0) throws IOException {
    ...
    public static h1 a3(ByteBuffer byteBuffer0) throws y0 {
    ...
    public static h1 b3(ByteBuffer byteBuffer0, V v0) throws y0 {
    ...
    public static h1 c3(byte[] arr_b) throws y0 {
        return (h1)l0.s2(h1.DEFAULT_INSTANCE, arr_b);
    }

    public static h1 d3(byte[] arr_b, V v0) throws y0 {
