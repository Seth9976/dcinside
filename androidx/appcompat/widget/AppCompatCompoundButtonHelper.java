...
class AppCompatCompoundButtonHelper {
    ...
    AppCompatCompoundButtonHelper(@NonNull CompoundButton compoundButton0) {
        this.b = null;
        this.c = null;
        this.d = false;
        this.e = false;
    ...
    void a() {
        Drawable drawable0 = CompoundButtonCompat.a(this.a);
    ...
    void d(@Nullable AttributeSet attributeSet0, int v) {
        TintTypedArray tintTypedArray0 = TintTypedArray.G(this.a.getContext(), attributeSet0, styleable.CompoundButton, v, 0);
        Context context0 = this.a.getContext();
        ViewCompat.H1(this.a, context0, styleable.CompoundButton, attributeSet0, tintTypedArray0.B(), v, 0);
        try {
            if(tintTypedArray0.C(styleable.CompoundButton_buttonCompat)) {
            ...
            label_10:
                if(tintTypedArray0.C(styleable.CompoundButton_android_button)) {
        ...
        label_15:
            if(tintTypedArray0.C(styleable.CompoundButton_buttonTint)) {
                ColorStateList colorStateList0 = tintTypedArray0.d(2);
                CompoundButtonCompat.d(this.a, colorStateList0);
            }
            if(tintTypedArray0.C(styleable.CompoundButton_buttonTintMode)) {
                PorterDuff.Mode porterDuff$Mode0 = DrawableUtils.e(tintTypedArray0.o(3, -1), null);
                CompoundButtonCompat.e(this.a, porterDuff$Mode0);
            }
        }
        finally {
            tintTypedArray0.I();
