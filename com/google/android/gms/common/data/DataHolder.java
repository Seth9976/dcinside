...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @Constructor
    DataHolder(@Param(id = 1000) int v, @Param(id = 1) String[] arr_s, @Param(id = 2) CursorWindow[] arr_cursorWindow, @Param(id = 3) int v1, @Nullable @Param(id = 4) Bundle bundle0) {
        this.zae = false;
        this.zak = true;
        this.zaa = v;
        this.zag = arr_s;
    ...
    private DataHolder(Builder dataHolder$Builder0, int v, @Nullable Bundle bundle0) {
        this(dataHolder$Builder0.zaa, DataHolder.zaf(dataHolder$Builder0, -1), v, null);
    }

    DataHolder(Builder dataHolder$Builder0, int v, Bundle bundle0, int v1, zae zae0) {
        this(dataHolder$Builder0.zaa, DataHolder.zaf(dataHolder$Builder0, -1), v, bundle0);
    }
    ...
    private static CursorWindow[] zaf(Builder dataHolder$Builder0, int v) {
        if(dataHolder$Builder0.zaa.length == 0) {
            return new CursorWindow[0];
        }
        ArrayList arrayList0 = dataHolder$Builder0.zab;
        int v2 = arrayList0.size();
        CursorWindow cursorWindow0 = new CursorWindow(false);
        ArrayList arrayList1 = new ArrayList();
        arrayList1.add(cursorWindow0);
        cursorWindow0.setNumColumns(dataHolder$Builder0.zaa.length);
        int v3 = 0;
        boolean z = false;
        while(v3 < v2) {
            try {
                ...
                int v4 = 0;
                boolean z1 = true;
                while(v4 < dataHolder$Builder0.zaa.length) {
                    if(!z1) {
                        goto label_56;
                    }
                    String s = dataHolder$Builder0.zaa[v4];
