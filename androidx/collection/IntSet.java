...
public abstract class IntSet {
    ...
    public static String D(IntSet intSet0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return intSet0.w(charSequence0, charSequence5, charSequence4, ((v1 & 8) == 0 ? v : -1), charSequence3);
    }

    public static String E(IntSet intSet0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function1 function10, int v1, Object object0) {
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        }
        ...
        if(v >= 0) {
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    int v3 = 8 - (~(v1 - v) >>> 0x1F);
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L && !((IntSet)object0).d(arr_v[(v1 << 3) + v4])) {
                            return false;
                        }
                        v2 >>= 8;
                    }
    ...
    public final int i(@l Function1 function10) {
        L.p(function10, "predicate");
        int[] arr_v = this.b;
        long[] arr_v1 = this.a;
        int v = arr_v1.length - 2;
    ...
    public final String r() {
        return IntSet.D(this, null, null, null, 0, null, 0x1F, null);
    }
    ...
    public final String s(@l CharSequence charSequence0) {
        L.p(charSequence0, "separator");
        return IntSet.D(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String t(@l CharSequence charSequence0, @l CharSequence charSequence1) {
        L.p(charSequence0, "separator");
        L.p(charSequence1, "prefix");
        return IntSet.D(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }

    @Override
    @l
    public String toString() {
        return IntSet.D(this, null, "[", "]", 0, null, 25, null);
    }
    ...
    public final String u(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2) {
        ...
        return IntSet.D(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String v(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2, int v) {
        ...
        L.p(charSequence1, "prefix");
        L.p(charSequence2, "postfix");
        return IntSet.D(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
