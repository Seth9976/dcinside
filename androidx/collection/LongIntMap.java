...
public abstract class LongIntMap {
            ...
            while(true) {
                ...
                while(v5 < v4) {
                    if((v3 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)o0.invoke(v7, v8)));
                        ++v2;
                    }
                    v3 >>= 8;
                    ++v5;
    ...
    public final String B(@l CharSequence charSequence0) {
        ...
        return LongIntMap.L(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String D(@l CharSequence charSequence0, @l CharSequence charSequence1) {
        ...
        return LongIntMap.L(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String F(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2) {
        ...
        return LongIntMap.L(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String G(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2, int v) {
        ...
        L.p(charSequence1, "prefix");
        L.p(charSequence2, "postfix");
        return LongIntMap.L(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
            ...
            while(true) {
                ...
                while(v6 < v5) {
                    if((v4 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)o0.invoke(v8, v9)));
                        ++v3;
                    }
                    v4 >>= 8;
                    ++v6;
            ...
            while(true) {
                ...
                while(v7 < v6) {
                    if((v4 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)o0.invoke(v9, v10)));
                        ++v3;
                    }
                    v4 >>= 8;
                    ++v7;
    ...
    public static String L(LongIntMap longIntMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return longIntMap0.I(charSequence0, charSequence5, charSequence4, ((v1 & 8) == 0 ? v : -1), charSequence3);
    }

    public static String M(LongIntMap longIntMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, o o0, int v1, Object object0) {
        long[] arr_v4;
        long[] arr_v3;
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        long[] arr_v = longIntMap0.b;
        int[] arr_v1 = longIntMap0.c;
        long[] arr_v2 = longIntMap0.a;
            ...
            while(true) {
                ...
                while(v8 < v7) {
                    if((v5 & 0xFFL) < 0x80L) {
                        ...
                        arr_v3 = arr_v2;
                        stringBuilder0.append(((CharSequence)o0.invoke(v10, v11)));
                        ++v4;
                    }
                    else {
                        arr_v3 = arr_v2;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(!((Boolean)o0.invoke(((long)arr_v[v5]), ((int)arr_v1[v5]))).booleanValue()) {
                                return false;
                            }
                        }
                        v2 >>= 8;
    ...
    public boolean equals(@m Object object0) {
        ...
        if(!(object0 instanceof LongIntMap)) {
            return false;
        }
        if(((LongIntMap)object0).t() != this.t()) {
            return false;
        }
        long[] arr_v = this.b;
        int[] arr_v1 = this.c;
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; v4 = v6 + 1) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            v6 = v4;
                            if(arr_v1[v5] != ((LongIntMap)object0).n(arr_v[v5])) {
                                return false;
                            }
                        }
                        else {
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            if(((Boolean)o0.invoke(((long)arr_v[v6]), ((int)arr_v1[v6]))).booleanValue()) {
                                ++v2;
                            }
                        }
                        v3 >>= 8;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            o0.invoke(((long)arr_v[v5]), ((int)arr_v1[v5]));
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final int r(long v, int v1) {
        int v2 = this.i(v);
        return v2 < 0 ? v1 : this.c[v2];
    }

    public final int s(long v, @l A3.a a0) {
        L.p(a0, "defaultValue");
        int v1 = this.i(v);
        return v1 >= 0 ? this.c[v1] : ((Number)a0.invoke()).intValue();
    }
    ...
    public final String z() {
        return LongIntMap.L(this, null, null, null, 0, null, 0x1F, null);
    }
}
