...
public class SM extends Zh {
    public SM(@NonNull Context context0, @NonNull Owx owx0, @NonNull String s, int v) {
    ...
    protected DWo PjT(float f, float f1, float f2, float f3, SparseArray sparseArray0, long v, long v1, View view0, View view1, String s, float f4, int v2, float f5, int v3, JSONObject jSONObject0, JSONObject jSONObject1) {
        ...
        this.Owx = 0;
        PjT dWo$PjT0 = new PjT().cz(f8).JQp(f9).cr(f7).ReZ(f6).Zh(v9).PjT(v10).Zh(arr_v).PjT(arr_v1).ReZ(qZS.ReZ(view0)).cr(arr_v2).cr(this.iZZ).JQp(this.Yo).cz(this.KM);
        return com.bytedance.sdk.openadsdk.core.SM.Zh().PjT() ? dWo$PjT0.Zh(1).PjT(sparseArray0).PjT(s).PjT(v3).PjT(jSONObject0).Zh(jSONObject1).PjT() : dWo$PjT0.Zh(2).PjT(sparseArray0).PjT(s).PjT(v3).PjT(jSONObject0).Zh(jSONObject1).PjT();
    }
