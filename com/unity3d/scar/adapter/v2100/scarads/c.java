...
public class c extends a {
    ...
    public c(Context context0, RelativeLayout relativeLayout0, Q2.a a0, d d0, int v, int v1, com.unity3d.scar.adapter.common.d d1, g g0) {
        super(context0, d0, a0, d1);
        this.g = relativeLayout0;
        this.h = v;
        this.i = v1;
        this.j = new AdView(this.b);
        this.e = new com.unity3d.scar.adapter.v2100.scarads.d(g0, this);
    }
    ...
    protected void c(AdRequest adRequest0, P2.c c0) {
        ...
        if(relativeLayout0 != null) {
            ...
            if(adView0 != null) {
                ...
                this.j.setAdListener(((com.unity3d.scar.adapter.v2100.scarads.d)this.e).d());
