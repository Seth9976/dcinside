...
public class fDm extends FrameLayout {
    private boolean JQp;
    private Context PjT;
    private cr ReZ;
    ...
    public fDm(@NonNull Context context0) {
        super(context0);
        this.JQp = true;
        this.PjT = context0;
        ...
        this.post(new Runnable() {
            ...
            @Override
            public void run() {
                FrameLayout.LayoutParams frameLayout$LayoutParams0 = (FrameLayout.LayoutParams)fDm.this.Zh.getLayoutParams();
                frameLayout$LayoutParams0.topMargin = ((int)(((float)fDm.this.ReZ.getMeasuredHeight()) / 2.0f - XX.PjT(fDm.this.getContext(), 5.0f))) + ((int)XX.PjT(fDm.this.PjT, 20.0f));
                frameLayout$LayoutParams0.leftMargin = ((int)(((float)fDm.this.ReZ.getMeasuredWidth()) / 2.0f - XX.PjT(fDm.this.getContext(), 5.0f))) + ((int)XX.PjT(fDm.this.PjT, 20.0f));
                frameLayout$LayoutParams0.bottomMargin = (int)(((float)(-fDm.this.ReZ.getMeasuredHeight())) / 2.0f + XX.PjT(fDm.this.getContext(), 5.0f));
                frameLayout$LayoutParams0.rightMargin = (int)(((float)(-fDm.this.ReZ.getMeasuredWidth())) / 2.0f + XX.PjT(fDm.this.getContext(), 5.0f));
                ...
                fDm.this.Zh.setLayoutParams(frameLayout$LayoutParams0);
            }
        });
    }
    ...
    private void ReZ() {
        this.ReZ = new cr(this.PjT);
        FrameLayout.LayoutParams frameLayout$LayoutParams0 = new FrameLayout.LayoutParams(((int)XX.PjT(this.PjT, 80.0f)), ((int)XX.PjT(this.PjT, 80.0f)));
        frameLayout$LayoutParams0.gravity = 0x800033;
        frameLayout$LayoutParams0.topMargin = (int)XX.PjT(this.PjT, 20.0f);
        ...
        FrameLayout.LayoutParams frameLayout$LayoutParams1 = new FrameLayout.LayoutParams(((int)XX.PjT(this.PjT, 80.0f)), ((int)XX.PjT(this.PjT, 80.0f)));
    ...
    private void cr() {
        ObjectAnimator objectAnimator0 = ObjectAnimator.ofFloat(this.Zh, "scaleX", new float[]{1.0f, 0.8f});
        ...
        objectAnimator0.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationRepeat(Animator animator0) {
                if(fDm.this.JQp) {
                    fDm.this.ReZ.PjT();
                    fDm.this.ReZ.setAlpha(1.0f);
                }
                else {
                    fDm.this.ReZ.Zh();
                    fDm.this.ReZ.setAlpha(0.0f);
                }
                fDm.this.JQp = !fDm.this.JQp;
            }

            @Override  // android.animation.Animator$AnimatorListener
            public void onAnimationStart(Animator animator0) {
                ObjectAnimator objectAnimator0 = ObjectAnimator.ofFloat(fDm.this.Zh, "alpha", new float[]{0.0f, 1.0f});
                objectAnimator0.setDuration(200L);
                objectAnimator0.setInterpolator(new LinearInterpolator());
                objectAnimator0.start();
                fDm.this.Zh.setVisibility(0);
            }
        });
        ObjectAnimator objectAnimator1 = ObjectAnimator.ofFloat(this.Zh, "scaleY", new float[]{1.0f, 0.8f});
