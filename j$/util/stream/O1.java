...
class o1 implements H0 {
    ...
    public final void e(Object object0) {
        for(int v = 0; v < this.b; ++v) {
            ((LongConsumer)object0).accept(this.a[v]);
        }
    }
    ...
    public final void r(int v, Object object0) {
        System.arraycopy(this.a, 0, ((long[])object0), v, this.b);
    }
    ...
    public String toString() {
        return String.format("LongArrayNode[%d][%s]", ((int)(this.a.length - this.b)), Arrays.toString(this.a));
    }
}
