...
public class ProviderInstaller {
            ...
            if(context3 != null) {
                ...
                if(!z) {
                    try {
                        ...
                        zzl.zzb("com.google.android.gms.common.security.ProviderInstallerImpl", "reportRequestStats2", context3.getClassLoader(), new zzj[]{zzj.zzb(Context.class, context0), zzi.zza(v), zzi.zza(v2)});
                    }
    ...
    @GuardedBy("ProviderInstaller.lock")
    private static void zzb(Context context0, Context context1, String s) throws GooglePlayServicesNotAvailableException {
        try {
