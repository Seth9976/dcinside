...
public class DialogStyle {
    public static class Builder {
        ...
        public DialogStyle build() {
            return new DialogStyle(this, null);
        }
    ...
    private DialogStyle(@NonNull Builder dialogStyle$Builder0) {
        this.adSize = dialogStyle$Builder0.adSize;
        this.defaultImageResId = dialogStyle$Builder0.defaultImageResId;
        this.defaultImageClickUrl = dialogStyle$Builder0.defaultImageClickUrl;
        this.backgroundColor = dialogStyle$Builder0.backgroundColor;
        this.messageText = dialogStyle$Builder0.messageText;
        this.messageTextColor = dialogStyle$Builder0.messageTextColor;
        this.messageTextSize = dialogStyle$Builder0.messageTextSize;
        this.buttonCount = dialogStyle$Builder0.buttonCount;
        this.buttonTextSize = dialogStyle$Builder0.buttonTextSize;
        this.firstButtonText = dialogStyle$Builder0.firstButtonText;
        this.firstButtonColor = dialogStyle$Builder0.firstButtonColor;
        this.firstButtonTextColor = dialogStyle$Builder0.firstButtonTextColor;
        this.secondButtonText = dialogStyle$Builder0.secondButtonText;
        this.secondButtonColor = dialogStyle$Builder0.secondButtonColor;
        this.secondButtonTextColor = dialogStyle$Builder0.secondButtonTextColor;
        this.thirdButtonText = dialogStyle$Builder0.thirdButtonText;
        this.thirdButtonColor = dialogStyle$Builder0.thirdButtonColor;
        this.thirdButtonTextColor = dialogStyle$Builder0.thirdButtonTextColor;
        this.radius = dialogStyle$Builder0.radius;
    }

    DialogStyle(Builder dialogStyle$Builder0, com.gomfactory.adpie.sdk.dialog.DialogStyle.1 dialogStyle$10) {
        this(dialogStyle$Builder0);
    }
    ...
    class com.gomfactory.adpie.sdk.dialog.DialogStyle.1 {
    }
