...
final class ComposerKt.endGroupInstance.1 extends N implements p {
    public static final ComposerKt.endGroupInstance.1 e;

    static {
        ComposerKt.endGroupInstance.1.e = new ComposerKt.endGroupInstance.1();
    }
