...
public class p {
    ...
    static enum b {
        ...
        static b b(String s) {
            ...
            return s.startsWith("UTF-") ? b.b : b.c;
        }
    }
    ...
    public static enum c {
        ...
        int j(String s) {
            int v = Arrays.binarySearch(this.a, s);
            return v < 0 ? -1 : this.b[v];
        }

        String k(int v) {
            int v1 = Arrays.binarySearch(this.c, v);
            if(v1 >= 0) {
                return v1 >= this.d.length - 1 || this.c[v1 + 1] != v ? this.d[v1] : this.d[v1 + 1];
            }
            return "";
        }
    ...
    private static org.jsoup.nodes.f.a f;
    ...
    private static void b(Appendable appendable0, c p$c0, int v) throws IOException {
        String s = p$c0.k(v);
        if(!"".equals(s)) {
            appendable0.append('&').append(s).append(';');
            return;
        }
        appendable0.append("&#x").append(Integer.toHexString(v)).append(';');
    }

    private static boolean c(b p$b0, char c, CharsetEncoder charsetEncoder0) {
        switch(p$b0) {
            case 1: {
                return c < 0x80;
            }
            ...
            default: {
                return charsetEncoder0.canEncode(c);
            }
        }
    }

    public static int d(String s, int[] arr_v) {
        String s1 = (String)p.e.get(s);
        if(s1 != null) {
            arr_v[0] = s1.codePointAt(0);
            arr_v[1] = s1.codePointAt(1);
            return 2;
        }
        int v = c.g.j(s);
        if(v != -1) {
    ...
    public static String e(String s) {
        if(p.f == null) {
            p.f = new org.jsoup.nodes.f.a();
        }
        return p.f(s, p.f);
    }

    public static String f(String s, org.jsoup.nodes.f.a f$a0) {
        if(s == null) {
            return "";
        }
        StringBuilder stringBuilder0 = n.d();
        try {
            p.g(stringBuilder0, s, f$a0, true, true, false, false, false);
    ...
    static void g(Appendable appendable0, String s, org.jsoup.nodes.f.a f$a0, boolean z, boolean z1, boolean z2, boolean z3, boolean z4) throws IOException {
        c p$c0 = f$a0.g();
        CharsetEncoder charsetEncoder0 = f$a0.e();
        b p$b0 = f$a0.c;
        int v = s.length();
        int v1 = 0;
        boolean z5 = false;
            ...
            label_24:
                if(v2 < 0x10000) {
                    switch(((char)v2)) {
                        ...
                        case 60: {
                            if(z || p$c0 == c.e || f$a0.r() == org.jsoup.nodes.f.a.a.b) {
                                appendable0.append("&lt;");
                            }
                            else {
                                appendable0.append(((char)v2));
                        ...
                        default: {
                            if(((char)v2) < 0x20 || !p.c(p$b0, ((char)v2), charsetEncoder0)) {
                                p.b(appendable0, p$c0, v2);
                            }
                            else {
                                appendable0.append(((char)v2));
                            }
                    ...
                    String s1 = new String(Character.toChars(v2));
    ...
    public static String h(String s) {
        ...
        int v = c.g.j(s);
        return v == -1 ? "" : new String(new int[]{v}, 0, 1);
    }
    ...
    private static void k(c p$c0, String s, int v) {
        int v5;
        p$c0.a = new String[v];
        p$c0.b = new int[v];
        p$c0.c = new int[v];
        p$c0.d = new String[v];
        org.jsoup.parser.a a0 = new org.jsoup.parser.a(s);
        boolean z = false;
        int v1 = 0;
        try {
            while(!a0.w()) {
                String s1 = a0.p('=');
                a0.a();
                int v3 = Integer.parseInt(a0.r(p.d), 36);
                int v4 = a0.v();
                a0.a();
                if(v4 == 44) {
                    v5 = Integer.parseInt(a0.p(';'), 36);
                    a0.a();
                }
                else {
                    v5 = -1;
                }
                int v6 = Integer.parseInt(a0.p('&'), 36);
                a0.a();
                p$c0.a[v1] = s1;
                p$c0.b[v1] = v3;
                p$c0.c[v6] = v3;
                p$c0.d[v6] = s1;
                if(v5 != -1) {
                    String s2 = new String(new int[]{v3, v5}, 0, 2);
                    p.e.put(s1, s2);
                }
                ++v1;
            }
            ...
            org.jsoup.helper.i.i(z, "Unexpected count of entities loaded");
        }
        finally {
            a0.d();
        }
    ...
    static String m(String s, boolean z) {
        return g.v(s, z);
    }
}
