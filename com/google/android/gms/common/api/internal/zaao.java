    ...
    public final void zaa() {
        ...
        if(arrayList0.isEmpty()) {
            ...
            while(v < v2) {
                ...
                v1 = zal0.zab(this.zaa.zac, api$Client1);
                ++v;
                if(v1 == 0) {
                    break;
                }
            ...
            while(v < v3) {
                ...
                v1 = zal0.zab(this.zaa.zac, api$Client2);
                ++v;
                if(v1 != 0) {
                    break;
                }
        ...
        if(v1 != 0) {
            ...
            this.zaa.zaa.zal(zaam0);
            return;
        }
        zaaw zaaw0 = this.zaa;
        if(zaaw0.zam && zaaw0.zak != null) {
            zaaw0.zak.zab();
        }
        for(Object object1: this.zac.keySet()) {
            ...
            if(api$Client3.requiresGooglePlayServices() && zal0.zab(this.zaa.zac, api$Client3) != 0) {
                zaan zaan0 = new zaan(this, this.zaa, baseGmsClient$ConnectionProgressReportCallbacks0);
                this.zaa.zaa.zal(zaan0);
            }
            else {
