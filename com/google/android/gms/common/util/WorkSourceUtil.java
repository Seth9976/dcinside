...
public class WorkSourceUtil {
    ...
    static {
        ...
        Class class1 = WorkSource.class;
        WorkSourceUtil.zza = Process.myUid();
        try {
            method0 = null;
            method0 = class1.getMethod("add", Integer.TYPE);
        }
        ...
        try {
            ...
            method1 = null;
            method1 = class1.getMethod("add", Integer.TYPE, class0);
        }
        catch(Exception unused_ex) {
        }
        try {
            ...
            method2 = null;
            method2 = class1.getMethod("size", null);
        }
        catch(Exception unused_ex) {
        }
        try {
            ...
            method3 = null;
            method3 = class1.getMethod("get", Integer.TYPE);
        }
        catch(Exception unused_ex) {
        }
        try {
            ...
            method4 = null;
            method4 = class1.getMethod("getName", Integer.TYPE);
        }
        catch(Exception unused_ex) {
        }
        try {
            WorkSourceUtil.zzf = method4;
            method5 = class1.getMethod("createWorkChain", null);
        }
        ...
        try {
            ...
            method6 = Class.forName("android.os.WorkSource$WorkChain").getMethod("addNode", Integer.TYPE, class0);
        }
        ...
        try {
            ...
            method7 = null;
            method7 = class1.getMethod("isEmpty", null);
