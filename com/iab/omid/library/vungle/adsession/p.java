...
public final class p {
    ...
    private p(String s, URL uRL0, String s1) {
        this.a = s;
        this.b = uRL0;
        this.c = s1;
    }

    public static p a(String s, URL uRL0, String s1) {
        g.f(s, "VendorKey is null or empty");
        g.d(uRL0, "ResourceURL is null");
        g.f(s1, "VerificationParameters is null or empty");
        return new p(s, uRL0, s1);
    }

    public static p b(URL uRL0) {
        g.d(uRL0, "ResourceURL is null");
        return new p(null, uRL0, null);
    }
