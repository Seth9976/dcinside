...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public MutableIntLongMap(int v, int v1, w w0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final long S(int v, @y4.l a a0) {
        L.p(a0, "defaultValue");
        int v1 = this.i(v);
        if(v1 < 0) {
    ...
    public final void a0(@y4.l IntLongMap intLongMap0) {
        L.p(intLongMap0, "from");
        this.d0(intLongMap0);
    }

    public final long b0(int v, long v1, long v2) {
        int v3 = this.R(v);
        if(v3 < 0) {
            v3 = ~v3;
        }
    ...
    public final void c0(int v, long v1) {
        this.k0(v, v1);
    }

    public final void d0(@y4.l IntLongMap intLongMap0) {
        L.p(intLongMap0, "from");
    ...
    public final boolean f0(int v, long v1) {
        int v2 = this.i(v);
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)o0.invoke(((int)this.b[v5]), ((long)this.c[v5]))).booleanValue()) {
                                this.i0(v5);
                            }
                        }
                        v2 >>= 8;
