...
public class b extends e {
    ...
    public Object g(n n0, h h0) throws IOException {
        ...
        for(int v = 0; true; ++v) {
            ...
            if(v == arr_y.length) {
                if(!this.s && h0.J0(i.g)) {
                    h0.i1(this, r1, "Unexpected JSON values; expected at most %d properties (in JSON Array)", new Object[]{((int)arr_y.length)});
                }
                do {
                    n0.I4();
                }
    ...
    @Override  // com.fasterxml.jackson.databind.deser.e
    public e l2(c c0) {
        return new b(this.B.l2(c0), this.C);
    }

    @Override  // com.fasterxml.jackson.databind.deser.e
    public e m2(Set set0, Set set1) {
        return new b(this.B.m2(set0, set1), this.C);
    }

    @Override  // com.fasterxml.jackson.databind.deser.e
    public e o2(boolean z) {
        return new b(this.B.o2(z), this.C);
    }

    @Override  // com.fasterxml.jackson.databind.deser.e
    public e p2(s s0) {
        return new b(this.B.p2(s0), this.C);
    }

    protected Object s2(n n0, h h0) throws IOException {
        return h0.u0(this.l1(h0), n0.Y(), n0, "Cannot deserialize a POJO (of type %s) from non-Array representation (token: %s): type/property designed to be serialized as JSON Array", new Object[]{com.fasterxml.jackson.databind.util.h.Q(this.f), n0.Y()});
    }
                ...
                if(!y0.l(s) || y2 != null) {
                    if(y2 == null) {
                        ...
                        if(object0.getClass() != this.f.g()) {
                            Object[] arr_object = {com.fasterxml.jackson.databind.util.h.Q(this.f), com.fasterxml.jackson.databind.util.h.D(object0)};
                            h0.D(this.f, String.format("Cannot support implicit polymorphic deserialization for POJOs-as-Arrays style: nominal type %s, actual type %s", arr_object));
                        }
                    }
                }
            }
