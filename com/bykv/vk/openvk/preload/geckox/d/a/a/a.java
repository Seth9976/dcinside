...
public class a extends d {
    private static Object a(b b0, Pair pair0) throws Throwable {
        GeckoLogger.d("gecko-debug-tag", new Object[]{"start check full single file channel:", ((UpdatePackage)pair0.second).getChannel()});
        ...
        try {
            ...
            throw new com.bykv.vk.openvk.preload.geckox.b.b("check full single file failed, channel:" + updatePackage0.getChannel() + ", pkg id:" + updatePackage0.getFullPackage().getId() + ", caused by:" + throwable0.getMessage(), throwable0);
        }
    }
