...
public class Zh implements qla {
    ...
    public DWo PjT(String s) {
        return new com.bytedance.sdk.component.JQp.ReZ.ReZ.Zh(this.PjT).ReZ(s);
    }
        ...
        if(this.PjT != null) {
            ...
            if(collection0 != null) {
                for(Object object0: collection0) {
                    byte[] arr_b = (byte[])((gK)object0).PjT(s1);
                    if(arr_b != null) {
            ...
            Collection collection1 = this.PjT.ReZ();
            if(collection1 != null) {
                for(Object object1: collection1) {
                    InputStream inputStream0 = ((ReZ)object1).PjT(s1);
