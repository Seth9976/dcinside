...
public class CombinedParallelSampleBandwidthEstimator implements BandwidthEstimator {
    public static class Builder {
        ...
        public CombinedParallelSampleBandwidthEstimator e() {
            return new CombinedParallelSampleBandwidthEstimator(this, null);
        }
    ...
    private CombinedParallelSampleBandwidthEstimator(Builder combinedParallelSampleBandwidthEstimator$Builder0) {
        this.b = combinedParallelSampleBandwidthEstimator$Builder0.a;
        this.c = combinedParallelSampleBandwidthEstimator$Builder0.b;
        this.d = combinedParallelSampleBandwidthEstimator$Builder0.c;
        this.f = combinedParallelSampleBandwidthEstimator$Builder0.d;
        this.e = new EventDispatcher();
        this.j = 0x8000000000000000L;
        this.k = 0x8000000000000000L;
    }

    CombinedParallelSampleBandwidthEstimator(Builder combinedParallelSampleBandwidthEstimator$Builder0, androidx.media3.exoplayer.upstream.experimental.CombinedParallelSampleBandwidthEstimator.1 combinedParallelSampleBandwidthEstimator$10) {
        this(combinedParallelSampleBandwidthEstimator$Builder0);
    }

    @Override  // androidx.media3.exoplayer.upstream.experimental.BandwidthEstimator
    public void a(EventListener bandwidthMeter$EventListener0) {
        this.e.e(bandwidthMeter$EventListener0);
    }
    ...
    public void c(Handler handler0, EventListener bandwidthMeter$EventListener0) {
        this.e.b(handler0, bandwidthMeter$EventListener0);
    }
    ...
    public void e(DataSource dataSource0) {
        ...
        long v1 = (long)(((int)(this.f.elapsedRealtime() - this.h)));
        if(v1 > 0L) {
    ...
    public void g(long v) {
        long v1 = this.f.elapsedRealtime();
    ...
    class androidx.media3.exoplayer.upstream.experimental.CombinedParallelSampleBandwidthEstimator.1 {
    }
