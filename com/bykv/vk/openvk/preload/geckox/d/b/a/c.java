...
public class c extends d {
    ...
    public final Object a(b b0, Object object0) throws Throwable {
        GeckoLogger.d("gecko-debug-tag", new Object[]{"start active full zip file, channel:", ((UpdatePackage)((Pair)object0).second).getChannel()});
        ...
        if(!file0.renameTo(file1)) {
            throw new RuntimeException("active full zip file failed:" + file0.getAbsolutePath());
        }
