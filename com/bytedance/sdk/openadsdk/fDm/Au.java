...
public class Au extends DWo {
    public Au(Context context0) {
        this(context0, null);
    }

    public Au(Context context0, AttributeSet attributeSet0) {
    ...
    protected void PjT(Context context0) {
        ...
        int v2 = qZS.Zh(context0, 15.0f);
        int v3 = qZS.Zh(context0, 20.0f);
        ...
        relativeLayout$LayoutParams2.rightMargin = v2;
        relativeLayout$LayoutParams2.leftMargin = v2;
        relativeLayout$LayoutParams2.bottomMargin = v2;
        relativeLayout$LayoutParams2.setMarginEnd(v2);
        relativeLayout$LayoutParams2.setMarginStart(v2);
        ...
        com.bytedance.sdk.openadsdk.core.JQp.Au au0 = this.Zh(context0);
        this.cr = au0;
        au0.setId(qla.jp);
        ...
        relativeLayout$LayoutParams4.leftMargin = v3;
        relativeLayout$LayoutParams4.setMarginStart(v3);
        ...
        xX1.addView(this.cr);
        com.bytedance.sdk.openadsdk.core.JQp.Au au1 = this.cr(context0);
        this.cz = au1;
        au1.setId(qla.Wo);
        RelativeLayout.LayoutParams relativeLayout$LayoutParams5 = new RelativeLayout.LayoutParams(qZS.Zh(context0, 100.0f), qZS.Zh(context0, 30.0f));
        ...
        relativeLayout$LayoutParams6.leftMargin = v1;
    ...
    @Override  // com.bytedance.sdk.openadsdk.fDm.DWo
    protected com.bytedance.sdk.openadsdk.core.JQp.Au Zh(Context context0) {
        com.bytedance.sdk.openadsdk.core.JQp.Au au0 = super.Zh(context0);
        au0.setGravity(16);
        au0.setMaxWidth(qZS.Zh(context0, 250.0f));
        au0.setTextColor(-1);
    ...
    @Override  // com.bytedance.sdk.openadsdk.fDm.DWo
    protected com.bytedance.sdk.openadsdk.core.JQp.Au cr(Context context0) {
        com.bytedance.sdk.openadsdk.core.JQp.Au au0 = super.cr(context0);
