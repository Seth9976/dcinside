...
public final class zabq implements ConnectionCallbacks, OnConnectionFailedListener, zau {
    ...
    @Nullable
    @WorkerThread
    private final Feature zaC(@Nullable Feature[] arr_feature) {
    ...
    @WorkerThread
    private final void zaF(@Nullable Status status0, @Nullable Exception exception0, boolean z) {
        Preconditions.checkHandlerThread(this.zaa.zar);
    ...
    @WorkerThread
    private final boolean zaN(@NonNull ConnectionResult connectionResult0) {
