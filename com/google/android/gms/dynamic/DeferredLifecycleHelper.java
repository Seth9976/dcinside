...
public abstract class DeferredLifecycleHelper {
    ...
    @KeepForSdk
    protected abstract void createDelegate(@NonNull OnDelegateCreatedListener arg1);
    ...
    @KeepForSdk
    protected void handleGooglePlayUnavailable(@NonNull FrameLayout frameLayout0) {
    ...
    static void zad(DeferredLifecycleHelper deferredLifecycleHelper0, Bundle bundle0) {
    ...
    private final void zaf(@Nullable Bundle bundle0, zah zah0) {
        LifecycleDelegate lifecycleDelegate0 = this.zaa;
        if(lifecycleDelegate0 != null) {
