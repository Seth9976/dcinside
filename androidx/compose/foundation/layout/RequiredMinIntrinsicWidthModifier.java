...
final class RequiredMinIntrinsicWidthModifier implements IntrinsicSizeModifier {
    @l
    public static final RequiredMinIntrinsicWidthModifier a;
    private static final boolean b;

    static {
        RequiredMinIntrinsicWidthModifier.a = new RequiredMinIntrinsicWidthModifier();
    }

    @Override  // androidx.compose.foundation.layout.IntrinsicSizeModifier
    public boolean F1() {
        return RequiredMinIntrinsicWidthModifier.b;
    }
    ...
    public long u1(@l MeasureScope measureScope0, @l Measurable measurable0, long v) {
        ...
        int v1 = measurable0.S0(Constraints.o(v));
