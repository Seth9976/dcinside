...
final class zzja extends zzhj implements zzjl, zzkw, RandomAccess {
    private static final zzja zza;
    private float[] zzb;
    private int zzc;

    static {
        zzja zzja0 = new zzja(new float[0], 0);
        zzja.zza = zzja0;
        zzja0.zzb();
    }
    ...
    private zzja(float[] arr_f, int v) {
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final zzjl zza(int v) {
        ...
        return new zzja(Arrays.copyOf(this.zzb, v), this.zzc);
    }
