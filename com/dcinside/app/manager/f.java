...
public class f extends WebChromeClient {
    ...
    // 检测为 Lambda 实现
    public static void c(JsResult jsResult0, DialogInterface dialogInterface0, int v) [...]
    ...
    public boolean onJsConfirm(WebView webView0, String s, String s1, JsResult jsResult0) {
        ...
        this.a = new WeakReference(new Builder(webView0.getContext()).F(0x7F15009B).l(s1).setPositiveButton(0x104000A, (DialogInterface dialogInterface0, int v) -> f.e(jsResult0, dialogInterface0, v)).setNegativeButton(0x1040000, (DialogInterface dialogInterface0, int v) -> jsResult0.cancel()).b(false).I());
        return true;
    }
}
