...
public final class b extends ImageSpan {
    ...
    public b(@l Context context0, int v, @m ColorStateList colorStateList0, int v1, int v2, boolean z, @m Float float0) {
        ...
        this.e = z;
        this.f = float0;
        this.g = new t(null, 1, null);
    }

    public b(Context context0, int v, ColorStateList colorStateList0, int v1, int v2, boolean z, Float float0, int v3, w w0) {
        this(context0, v, ((v3 & 4) == 0 ? colorStateList0 : null), ((v3 & 8) == 0 ? v1 : 0), ((v3 & 16) == 0 ? v2 : 0), ((v3 & 0x20) == 0 ? z : false), ((v3 & 0x40) == 0 ? float0 : null));
    }

    public b(@l Context context0, @l i i0) {
        L.p(context0, "context");
        L.p(i0, "option");
        this(context0, i0.i(), i0.j(), i0.k(), i0.h(), i0.l(), null, 0x40, null);
    }

    private final Drawable a() {
        Drawable drawable0 = (Drawable)this.g.a();
        if(drawable0 == null) {
            ...
            if(this.e) {
                ...
                this.g = new t(roundedBitmapDrawable0);
    ...
    public void draw(@l Canvas canvas0, @l CharSequence charSequence0, int v, int v1, float f, int v2, int v3, int v4, @l Paint paint0) {
        ...
        canvas0.translate(f, ((float)(v4 - drawable0.getBounds().bottom + (v5 - v7 + v6) / 2)) - (this.f == null ? 0.0f : ((float)this.f)));
