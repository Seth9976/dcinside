...
public final class HeifExtractor implements Extractor {
    ...
    private static final int g = 0x68656963;
    private static final int h = 4;

    public HeifExtractor() {
        this.d = new ParsableByteArray(4);
        this.e = new SingleSampleExtractor(-1, -1, "image/heif");
    }
    ...
    public boolean g(ExtractorInput extractorInput0) throws IOException {
        extractorInput0.q(4);
        return this.b(extractorInput0, 0x66747970) && this.b(extractorInput0, 0x68656963);
    }
