...
public class a extends c {
    static class javassist.expr.a.a implements m {
        int a;
        l b;

        javassist.expr.a.a(int v, l l0) {
            this.a = v;
            this.b = l0;
        }
        ...
        public void b(e e0, j j0, javassist.compiler.ast.a a0) throws javassist.compiler.c {
            if(e0.j1(a0) != 1) {
                throw new javassist.compiler.c("$proceed() cannot take more than one parameter for cast");
            }
    ...
    protected a(int v, q q0, l l0, T t0) {
        super(v, q0, l0, t0);
    }
    ...
    public void k(String s) throws b {
        ...
        try {
            ...
            int v3 = d0.q(l0, true);
            d0.p(new javassist.expr.a.a(v1, l0));
            c.b(l0, s);
            j j0 = d0.h();
