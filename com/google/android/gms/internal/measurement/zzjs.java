...
final class zzjs extends zzie implements zzkc, zzlo, RandomAccess {
    ...
    static {
        ...
        zzjs.zza = arr_f;
        new zzjs(arr_f, 0, false);
    }

    zzjs() {
        this(zzjs.zza, 0, true);
    }

    private zzjs(float[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
        ...
        if(v >= 0) {
            ...
            if(v <= v1) {
                ...
                if(v1 < arr_f.length) {
                    ...
                    float[] arr_f1 = new float[zzjs.zzd(arr_f.length)];
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzjs)) {
            return super.addAll(collection0);
        }
        int v = ((zzjs)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzjs)collection0).zzb, 0, this.zzb, this.zzc, ((zzjs)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzjs)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzjs)object0).zzc) {
            return false;
        }
        float[] arr_f = ((zzjs)object0).zzb;
    ...
    public final int hashCode() {
        ...
        for(int v1 = 0; v1 < this.zzc; ++v1) {
            v = v * 0x1F + Float.floatToIntBits(this.zzb[v1]);
        }
        return v;
    }
    ...
    public final zzkc zza(int v) {
        ...
        return v == 0 ? new zzjs(zzjs.zza, this.zzc, true) : new zzjs(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }

    public final void zza(float f) {
        this.zza();
        float[] arr_f = this.zzb;
        if(this.zzc == arr_f.length) {
            float[] arr_f1 = new float[zzjs.zzd(arr_f.length)];
            System.arraycopy(this.zzb, 0, arr_f1, 0, this.zzc);
            this.zzb = arr_f1;
        }
        int v = this.zzc;
        this.zzc = v + 1;
    ...
    final void zzc(int v) {
        ...
        int v1;
        for(v1 = arr_f.length; v1 < v; v1 = zzjs.zzd(v1)) {
        }
