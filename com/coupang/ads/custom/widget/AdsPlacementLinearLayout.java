...
public final class AdsPlacementLinearLayout extends LinearLayout implements AdsWidgetPlacement {
    @m
    ...
    @j
    public AdsPlacementLinearLayout(@l Context context0) {
        L.p(context0, "context");
        this(context0, null, 0, 6, null);
    }

    @j
    public AdsPlacementLinearLayout(@l Context context0, @m AttributeSet attributeSet0) {
        L.p(context0, "context");
        this(context0, attributeSet0, 0, 4, null);
    }

    @j
    public AdsPlacementLinearLayout(@l Context context0, @m AttributeSet attributeSet0, int v) {
        L.p(context0, "context");
    ...
    public AdsPlacementLinearLayout(Context context0, AttributeSet attributeSet0, int v, int v1, w w0) {
        if((v1 & 2) != 0) {
            attributeSet0 = null;
        }
        if((v1 & 4) != 0) {
    ...
    protected void onFinishInflate() {
        ...
        q.f(this, false, new Function1() {
            {
                AdsPlacementLinearLayout.this = adsPlacementLinearLayout0;
                super(1);
            }
            ...
            public final p invoke(@l View view0) {
                ...
                if(view0 instanceof AdsWidgetProduct) {
                    AdsPlacementLinearLayout.this.products.add(view0);
                    return p.c;
                }
                if(view0 instanceof AdsWidgetPlacement) {
                    AdsPlacementLinearLayout.this.placements.add(view0);
                    return p.c;
                }
                return p.a;
            }
    ...
    public void setAdsProductPage(@m AdsProductPage adsProductPage0) {
        ...
        for(Object object0: this.placements) {
            ((AdsWidgetPlacement)object0).setAdsProductPage(adsProductPage0);
        }
        int v = 0;
        for(Object object1: this.products) {
