...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    @Constructor
    public ApiFeatureRequest(@NonNull @Param(id = 1) List list0, @Param(id = 2) boolean z, @Nullable @Param(id = 3) String s, @Nullable @Param(id = 4) String s1) {
    ...
    @NonNull
    @KeepForSdk
    public static ApiFeatureRequest fromModuleInstallRequest(@NonNull ModuleInstallRequest moduleInstallRequest0) {
