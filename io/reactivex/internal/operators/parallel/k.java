...
public final class k extends b {
    ...
    static final class io.reactivex.internal.operators.parallel.k.b implements f3.a, e {
        final f3.a a;
        final o b;
        final c c;
        e d;
        ...
        io.reactivex.internal.operators.parallel.k.b(f3.a a0, o o0, c c0) {
            this.a = a0;
            this.b = o0;
            this.c = c0;
        }
    ...
    static final class io.reactivex.internal.operators.parallel.k.c implements f3.a, e {
        final d a;
        final o b;
        final c c;
        e d;
        ...
        io.reactivex.internal.operators.parallel.k.c(d d0, o o0, c c0) {
            this.a = d0;
            this.b = o0;
            this.c = c0;
        }
    ...
    public void Q(d[] arr_d) {
        ...
        for(int v = 0; v < arr_d.length; ++v) {
            d d0 = arr_d[v];
            arr_d1[v] = d0 instanceof f3.a ? new io.reactivex.internal.operators.parallel.k.b(((f3.a)d0), this.b, this.c) : new io.reactivex.internal.operators.parallel.k.c(d0, this.b, this.c);
        }
        this.a.Q(arr_d1);
    }
}
