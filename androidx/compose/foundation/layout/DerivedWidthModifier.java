...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public DerivedWidthModifier(@l WindowInsets windowInsets0, @l Function1 function10, @l p p0) {
    ...
    public boolean equals(@m Object object0) {
        ...
        return object0 instanceof DerivedWidthModifier ? L.g(this.d, ((DerivedWidthModifier)object0).d) && L.g(this.e, ((DerivedWidthModifier)object0).e) : false;
    }
    ...
    public MeasureResult h(@l MeasureScope measureScope0, @l Measurable measurable0, long v) {
        ...
        int v1 = ((Number)this.e.invoke(windowInsets0, layoutDirection0, measureScope0)).intValue();
        if(v1 == 0) {
            return MeasureScope.-CC.p(measureScope0, 0, 0, null, androidx.compose.foundation.layout.DerivedWidthModifier.measure.1.e, 4, null);
        }
        Placeable placeable0 = measurable0.r1(Constraints.e(v, v1, v1, 0, 0, 12, null));
        return MeasureScope.-CC.p(measureScope0, v1, placeable0.K1(), null, new Function1() {
            final Placeable e;
        ...
        final class androidx.compose.foundation.layout.DerivedWidthModifier.measure.1 extends N implements Function1 {
            public static final androidx.compose.foundation.layout.DerivedWidthModifier.measure.1 e;

            static {
                androidx.compose.foundation.layout.DerivedWidthModifier.measure.1.e = new androidx.compose.foundation.layout.DerivedWidthModifier.measure.1();
            }

            androidx.compose.foundation.layout.DerivedWidthModifier.measure.1() {
                super(1);
            }
