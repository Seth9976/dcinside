...
public class e {
    ...
    public static void b(Context context0, String s) {
        e.e(context0, s, null, null);
    }

    public static void c(Context context0, String s, c e$c0) {
        e.e(context0, s, null, e$c0);
    }

    public static void d(Context context0, String s, String s1) {
        e.e(context0, s, s1, null);
    }

    public static void e(Context context0, String s, String s1, c e$c0) {
        new f().i(context0, s, s1, e$c0);
    }
