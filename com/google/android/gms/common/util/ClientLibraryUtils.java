...
public class ClientLibraryUtils {
    @KeepForSdk
    public static int getClientVersion(@NonNull Context context0, @NonNull String s) {
    ...
    @Nullable
    @KeepForSdk
    public static PackageInfo getPackageInfo(@NonNull Context context0, @NonNull String s) {
        try {
