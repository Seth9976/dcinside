...
public final class a extends b {
    static final class io.reactivex.internal.operators.parallel.a.a extends h {
        final e3.b p;
        Object q;
        boolean r;
        private static final long s = 0xBDD6D15FD25180FCL;

        io.reactivex.internal.operators.parallel.a.a(d d0, Object object0, e3.b b0) {
            super(d0);
            this.q = object0;
            this.p = b0;
        }
    ...
    public a(b b0, Callable callable0, e3.b b1) {
        this.a = b0;
        this.b = callable0;
        this.c = b1;
    }
    ...
    public void Q(d[] arr_d) {
        ...
        for(int v = 0; v < arr_d.length; ++v) {
            ...
            arr_d1[v] = new io.reactivex.internal.operators.parallel.a.a(arr_d[v], object0, this.c);
        }
        this.a.Q(arr_d1);
    }
