...
public final class zam extends AbstractSafeParcelable {
    ...
    @Constructor
    zam(@Param(id = 1) int v, @Param(id = 2) String s, @Param(id = 3) com.google.android.gms.common.server.response.FastJsonResponse.Field fastJsonResponse$Field0) {
        this.zaa = v;
        this.zab = s;
        this.zac = fastJsonResponse$Field0;
    }

    zam(String s, com.google.android.gms.common.server.response.FastJsonResponse.Field fastJsonResponse$Field0) {
        this.zaa = 1;
        this.zab = s;
        this.zac = fastJsonResponse$Field0;
    }
