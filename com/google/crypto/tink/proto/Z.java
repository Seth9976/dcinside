...
public final class z extends l0 implements C {
    static class a {
        static final int[] a;
    ...
    public static final class b extends com.google.crypto.tink.shaded.protobuf.l0.b implements C {
        private b() {
        ...
        public com.google.crypto.tink.shaded.protobuf.R0.a B6(com.google.crypto.tink.shaded.protobuf.z z0) throws IOException {
            return super.r1(z0);
        }
        ...
        public b V1(com.google.crypto.tink.proto.D.b d$b0) {
            this.F1();
            ((z)this.b).g3(((D)d$b0.B1()));
            return this;
        }
        ...
        @Override  // com.google.crypto.tink.shaded.protobuf.l0$b
        public com.google.crypto.tink.shaded.protobuf.R0.a j9(com.google.crypto.tink.shaded.protobuf.z z0, V v0) throws IOException {
        ...
        @Override  // com.google.crypto.tink.shaded.protobuf.l0$b
        public com.google.crypto.tink.shaded.protobuf.a.a s1(com.google.crypto.tink.shaded.protobuf.z z0, V v0) throws IOException {
            return super.J1(z0, v0);
        }
    ...
    protected final Object C1(i l0$i0, Object object0, Object object1) {
        switch(l0$i0) {
            ...
            case 3: {
                return l0.e2(z.DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\u000B\u0002\t\u0003\n", new Object[]{"version_", "params_", "keyValue_"});
            }
            case 4: {
    ...
    private void P2(D d0) {
        d0.getClass();
        if(this.params_ != null && this.params_ != D.H2()) {
            this.params_ = (D)((com.google.crypto.tink.proto.D.b)D.J2(this.params_).K1(d0)).C1();
            return;
        }
        this.params_ = d0;
    }
    ...
    public static b Q2() {
        return (b)z.DEFAULT_INSTANCE.y1();
    }

    public static b R2(z z0) {
        return (b)z.DEFAULT_INSTANCE.z1(z0);
    }

    public static z S2(InputStream inputStream0) throws IOException {
        return (z)l0.i2(z.DEFAULT_INSTANCE, inputStream0);
    }

    public static z T2(InputStream inputStream0, V v0) throws IOException {
        return (z)l0.j2(z.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static z U2(u u0) throws y0 {
        return (z)l0.k2(z.DEFAULT_INSTANCE, u0);
    }

    public static z V2(u u0, V v0) throws y0 {
        return (z)l0.l2(z.DEFAULT_INSTANCE, u0, v0);
    }

    public static z W2(com.google.crypto.tink.shaded.protobuf.z z0) throws IOException {
        return (z)l0.m2(z.DEFAULT_INSTANCE, z0);
    }

    public static z X2(com.google.crypto.tink.shaded.protobuf.z z0, V v0) throws IOException {
        return (z)l0.n2(z.DEFAULT_INSTANCE, z0, v0);
    }

    public static z Y2(InputStream inputStream0) throws IOException {
        return (z)l0.o2(z.DEFAULT_INSTANCE, inputStream0);
    }

    public static z Z2(InputStream inputStream0, V v0) throws IOException {
        return (z)l0.p2(z.DEFAULT_INSTANCE, inputStream0, v0);
    }

    @Override  // com.google.crypto.tink.proto.C
    public D a() {
        return this.params_ == null ? D.H2() : this.params_;
    }

    public static z a3(ByteBuffer byteBuffer0) throws y0 {
        return (z)l0.q2(z.DEFAULT_INSTANCE, byteBuffer0);
    }
    ...
    public static z b3(ByteBuffer byteBuffer0, V v0) throws y0 {
        return (z)l0.r2(z.DEFAULT_INSTANCE, byteBuffer0, v0);
    }
    ...
    public static z c3(byte[] arr_b) throws y0 {
        return (z)l0.s2(z.DEFAULT_INSTANCE, arr_b);
    }

    public static z d3(byte[] arr_b, V v0) throws y0 {
        return (z)l0.t2(z.DEFAULT_INSTANCE, arr_b, v0);
    }
