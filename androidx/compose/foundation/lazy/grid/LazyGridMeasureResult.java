...
public final class LazyGridMeasureResult implements LazyGridLayoutInfo, MeasureResult {
    @m
    private final LazyGridMeasuredLine a;
    private final int b;
    ...
    public LazyGridMeasureResult(@m LazyGridMeasuredLine lazyGridMeasuredLine0, int v, boolean z, float f, @l MeasureResult measureResult0, @l List list0, int v1, int v2, int v3, boolean z1, @l Orientation orientation0, int v4, int v5) {
