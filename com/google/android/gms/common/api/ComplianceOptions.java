...
public final class ComplianceOptions extends AbstractSafeParcelable {
    ...
    @Constructor
    ComplianceOptions(@Param(id = 1) int v, @Param(id = 2) int v1, @Param(id = 3) int v2, @Param(id = 4) boolean z) {
        this.zzb = v;
        this.zzc = v1;
        this.zzd = v2;
        this.zze = z;
    ...
    @NonNull
    @KeepForSdk
    public static final Builder newBuilder(@NonNull Context context0) {
