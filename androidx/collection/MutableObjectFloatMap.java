...
public final class MutableObjectFloatMap extends ObjectFloatMap {
    ...
    public MutableObjectFloatMap(int v, int v1, w w0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final float S(Object object0, @y4.l a a0) {
        L.p(a0, "defaultValue");
        int v = this.i(object0);
        if(v >= 0) {
            return this.c[v];
        }
        float f = ((Number)a0.invoke()).floatValue();
        this.l0(object0, f);
        return f;
    }
    ...
    public final void b0(@y4.l ObjectFloatMap objectFloatMap0) {
        L.p(objectFloatMap0, "from");
        this.e0(objectFloatMap0);
    }

    public final float c0(Object object0, float f, float f1) {
        int v = this.R(object0);
        if(v < 0) {
            v = ~v;
        }
        else {
    ...
    public final void d0(Object object0, float f) {
        this.l0(object0, f);
    }

    public final void e0(@y4.l ObjectFloatMap objectFloatMap0) {
        L.p(objectFloatMap0, "from");
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            this.l0(arr_object[v5], arr_f[v5]);
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final boolean g0(Object object0, float f) {
        int v = this.i(object0);
        if(v >= 0 && this.c[v] == f) {
            this.j0(v);
            return true;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)o0.invoke(this.b[v5], ((float)this.c[v5]))).booleanValue()) {
                                this.j0(v5);
                            }
                        }
                        v2 >>= 8;
    ...
    public final void l0(Object object0, float f) {
        int v = this.R(object0);
        if(v < 0) {
            v = ~v;
        }
