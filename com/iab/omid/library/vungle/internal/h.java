...
public class h {
    ...
    public void d(WebView webView0, String s, com.iab.omid.library.vungle.adsession.h h0, String s1) {
        this.i(webView0, "error", new Object[]{h0.toString(), s1, s});
    }

    public void e(WebView webView0, String s, String s1) {
        this.i(webView0, "setDeviceLockState", new Object[]{s1});
    }
    ...
    public void r(WebView webView0, String s, String s1) {
