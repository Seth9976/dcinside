...
public final class n6 implements ViewBinding {
    ...
    @NonNull
    public static n6 a(@NonNull View view0) {
                    ...
                    if(((ResizeTextView)view4) != null) {
                        ...
                        if(((ResizeTextView)view5) != null) {
                            ...
                            if(((ImageView)view6) != null) {
                                return new n6(((DividerConstraintLayout)view0), ((ResizeTextView)view1), ((DividerConstraintLayout)view0), ((ImageView)view2), ((ResizeTextView)view3), ((ResizeTextView)view4), ((ResizeTextView)view5), ((ImageView)view6));
                            }
                        }
                    }
                }
    ...
    @NonNull
    public static n6 c(@NonNull LayoutInflater layoutInflater0) {
        return n6.d(layoutInflater0, null, false);
    }

    @NonNull
    public static n6 d(@NonNull LayoutInflater layoutInflater0, @Nullable ViewGroup viewGroup0, boolean z) {
        View view0 = layoutInflater0.inflate(0x7F0E0231, viewGroup0, false);  // layout:view_post_list_item_split
        if(z) {
