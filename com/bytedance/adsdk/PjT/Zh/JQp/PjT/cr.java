    ...
    public static Object PjT(Object object0, Number number0) {
        if(!(object0 instanceof Integer) && !(object0 instanceof Short) && !(object0 instanceof Byte)) {
            if(object0 instanceof Long) {
                return cr.PjT(((long)(((Long)object0))), number0);
            }
            if(object0 instanceof Float) {
                return cr.PjT(((float)(((Float)object0))), number0);
            }
            if(object0 instanceof Double) {
                return cr.PjT(((double)(((Double)object0))), number0);
            }
            if(object0 instanceof String) {
                try {
                    return cr.PjT(Float.parseFloat(((String)object0)), number0);
                }
        ...
        return cr.PjT(((Number)object0).intValue(), number0);
    }
}
