...
public class SnackbarOnDeniedPermissionListener extends BasePermissionListener {
    public static class Builder {
        ...
        public SnackbarOnDeniedPermissionListener build() {
            return new SnackbarOnDeniedPermissionListener(this.view, this.text, this.buttonText, this.onClickListener, this.snackbarCallback, this.duration, null);
        }
    ...
    private SnackbarOnDeniedPermissionListener(View view0, String s, String s1, View.OnClickListener view$OnClickListener0, a snackbar$a0, int v) {
        this.view = view0;
        this.text = s;
        this.buttonText = s1;
    ...
    SnackbarOnDeniedPermissionListener(View view0, String s, String s1, View.OnClickListener view$OnClickListener0, a snackbar$a0, int v, com.karumi.dexter.listener.single.SnackbarOnDeniedPermissionListener.1 snackbarOnDeniedPermissionListener$10) {
    ...
    class com.karumi.dexter.listener.single.SnackbarOnDeniedPermissionListener.1 {
    }
