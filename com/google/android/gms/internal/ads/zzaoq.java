...
class zzaoq extends X509Certificate {
    ...
    public zzaoq(X509Certificate x509Certificate0) {
    ...
    @Override
    public final void checkValidity(Date date0) throws CertificateExpiredException, CertificateNotYetValidException {
    ...
    @Override
    public final void verify(PublicKey publicKey0) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        this.zza.verify(publicKey0);
    }

    @Override
    public final void verify(PublicKey publicKey0, String s) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
