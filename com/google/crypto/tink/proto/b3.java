...
public final class b3 extends l0 implements e3 {
    static class a {
        static final int[] a;
    ...
    public static final class b extends com.google.crypto.tink.shaded.protobuf.l0.b implements e3 {
        private b() {
        ...
        @Override  // com.google.crypto.tink.proto.e3
        public u c() {
            return ((b3)this.b).c();
        }
    ...
    private static final b3 DEFAULT_INSTANCE = null;
    ...
    protected final Object C1(i l0$i0, Object object0, Object object1) {
        switch(l0$i0) {
            ...
            case 3: {
                return l0.e2(b3.DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0003\u0002\u0000\u0000\u0000\u0001\u000B\u0003\n", new Object[]{"version_", "keyValue_"});
            }
            case 4: {
                return b3.DEFAULT_INSTANCE;
            }
            case 5: {
                j1 j10 = b3.PARSER;
                if(j10 == null) {
                    Class class0 = b3.class;
                    synchronized(class0) {
                        j10 = b3.PARSER;
                        if(j10 == null) {
                            j10 = new c(b3.DEFAULT_INSTANCE);
                            b3.PARSER = j10;
                        }
                    }
                }
    ...
    public static b L2() {
        return (b)b3.DEFAULT_INSTANCE.y1();
    }

    public static b M2(b3 b30) {
        return (b)b3.DEFAULT_INSTANCE.z1(b30);
    }

    public static b3 N2(InputStream inputStream0) throws IOException {
        return (b3)l0.i2(b3.DEFAULT_INSTANCE, inputStream0);
    }

    public static b3 O2(InputStream inputStream0, V v0) throws IOException {
        return (b3)l0.j2(b3.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static b3 P2(u u0) throws y0 {
        return (b3)l0.k2(b3.DEFAULT_INSTANCE, u0);
    }

    public static b3 Q2(u u0, V v0) throws y0 {
        return (b3)l0.l2(b3.DEFAULT_INSTANCE, u0, v0);
    }

    public static b3 R2(z z0) throws IOException {
        return (b3)l0.m2(b3.DEFAULT_INSTANCE, z0);
    }

    public static b3 S2(z z0, V v0) throws IOException {
        return (b3)l0.n2(b3.DEFAULT_INSTANCE, z0, v0);
    }

    public static b3 T2(InputStream inputStream0) throws IOException {
        return (b3)l0.o2(b3.DEFAULT_INSTANCE, inputStream0);
    }

    public static b3 U2(InputStream inputStream0, V v0) throws IOException {
        return (b3)l0.p2(b3.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static b3 V2(ByteBuffer byteBuffer0) throws y0 {
        return (b3)l0.q2(b3.DEFAULT_INSTANCE, byteBuffer0);
    }

    public static b3 W2(ByteBuffer byteBuffer0, V v0) throws y0 {
        return (b3)l0.r2(b3.DEFAULT_INSTANCE, byteBuffer0, v0);
    }

    public static b3 X2(byte[] arr_b) throws y0 {
        return (b3)l0.s2(b3.DEFAULT_INSTANCE, arr_b);
    }

    public static b3 Y2(byte[] arr_b, V v0) throws y0 {
        return (b3)l0.t2(b3.DEFAULT_INSTANCE, arr_b, v0);
    }

    public static j1 Z2() {
        return b3.DEFAULT_INSTANCE.getParserForType();
    }

    private void a3(u u0) {
        u0.getClass();
        this.keyValue_ = u0;
    }
