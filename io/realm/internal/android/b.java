...
public class b {
    ...
    public static Date c(String s, ParsePosition parsePosition0) throws ParseException {
        int v19;
        TimeZone timeZone0;
        int v17;
        int v16;
    ...
    private static int d(String s, int v, int v1) throws NumberFormatException {
        int v4;
        int v2;
