...
class cr {
    ...
    public PjT PjT(String s, boolean z) {
        ...
        if(com.bytedance.sdk.openadsdk.common.PjT.PjT()) {
            com.bytedance.sdk.openadsdk.common.PjT pjT0 = com.bytedance.sdk.openadsdk.common.PjT.PjT("sp_full_screen_video");
    ...
    public String PjT(Owx owx0) {
        if(com.bytedance.sdk.openadsdk.common.PjT.PjT()) {
            return com.bytedance.sdk.openadsdk.common.PjT.PjT("sp_full_screen_video").PjT(owx0);
        }
    ...
    public String PjT(String s, String s1, int v) {
        if(com.bytedance.sdk.openadsdk.common.PjT.PjT()) {
            return com.bytedance.sdk.openadsdk.common.PjT.PjT("sp_full_screen_video").PjT(s, s1, v);
        }
        if(TextUtils.isEmpty(s)) {
            return null;
        }
        if(TextUtils.isEmpty(s1)) {
            s1 = com.bytedance.sdk.component.utils.JQp.PjT(s);
        }
    ...
    public void PjT() {
        ...
        int v;
        if(com.bytedance.sdk.openadsdk.common.PjT.PjT()) {
            com.bytedance.sdk.openadsdk.common.PjT.PjT("sp_full_screen_video").Zh();
            return;
        }
        try {
            v = 0;
            int v1 = Build.VERSION.SDK_INT;
            boolean z = SM.XX("sp_full_screen_video");
            ...
            if(file0.exists() && file0.isDirectory()) {
                File[] arr_file = file0.listFiles(new FileFilter() {
                    ...
                    public boolean accept(File file0) {
                        return file0 == null ? false : file0.getName().contains("sp_full_screen_video");
                    }
                });
                if(arr_file != null) {
                    v2 = 0;
            ...
            label_24:
                ...
                if(file2 != null && file2.exists() && file2.isDirectory()) {
                    File[] arr_file1 = file2.listFiles(new FileFilter() {
                        ...
                        @Override
                        public boolean accept(File file0) {
                            return file0 == null ? false : file0.getName().contains("full_screen_video_cache");
                        }
                    });
                    if(arr_file1 != null) {
                        while(true) {
    ...
    public void PjT(AdSlot adSlot0, PjT pjT0) {
        ...
        if(com.bytedance.sdk.openadsdk.common.PjT.PjT()) {
            com.bytedance.sdk.openadsdk.common.PjT.PjT("sp_full_screen_video").PjT(adSlot0, pjT0);
            return;
        }
    ...
    public void PjT(Owx owx0, com.bytedance.sdk.openadsdk.common.PjT.PjT pjT$PjT0) {
        ...
        if(com.bytedance.sdk.openadsdk.common.PjT.PjT()) {
            com.bytedance.sdk.openadsdk.common.PjT.PjT("sp_full_screen_video").PjT(owx0, pjT$PjT0);
            return;
        }
            ...
            pjT0.PjT(new com.bytedance.sdk.component.XX.PjT.PjT() {
                ...
                public void PjT(com.bytedance.sdk.component.XX.Zh.ReZ reZ0, com.bytedance.sdk.component.XX.Zh zh0) {
                    if(zh0.cz() && zh0.JQp() != null && zh0.JQp().exists()) {
                        ...
                        cr.this.PjT(true, owx0, ((long)zh0.PjT()), zh0.Zh());
                        return;
                    }
                    ...
                    cr.this.PjT(false, owx0, ((long)zh0.PjT()), zh0.Zh());
                }
                ...
                public void PjT(com.bytedance.sdk.component.XX.Zh.ReZ reZ0, IOException iOException0) {
                    ...
                    cr.this.PjT(false, owx0, -2L, iOException0.getMessage());
                }
            });
            return;
        }
    ...
    public void PjT(String s) {
        if(com.bytedance.sdk.openadsdk.common.PjT.PjT()) {
            com.bytedance.sdk.openadsdk.common.PjT.PjT("sp_full_screen_video").Zh(s);
            return;
        }
        this.ReZ.XX(s);
    }
    ...
    public void PjT(String s, Owx owx0) {
        if(com.bytedance.sdk.openadsdk.common.PjT.PjT()) {
            com.bytedance.sdk.openadsdk.common.PjT.PjT("sp_full_screen_video").PjT(s, owx0);
            return;
        }
        if(TextUtils.isEmpty(s)) {
            return;
