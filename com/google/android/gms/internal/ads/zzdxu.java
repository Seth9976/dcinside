...
public final class zzdxu extends zzdxs {
    ...
    zzdxu(Context context0, Executor executor0) {
        this.zzg = context0;
        this.zzh = executor0;
    ...
    label_15:
        ...
        return;
    label_18:
        zzv.zzp().zzw(throwable0, "RemoteSignalsClientTask.onConnected");
    ...
    public final t0 zza(zzbvk zzbvk0) {
        synchronized(this.zzb) {
            ...
            zzdxt zzdxt0 = new zzdxt(this);
            this.zza.addListener(zzdxt0, zzbzw.zzg);
