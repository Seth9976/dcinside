...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements EmojiCompatConfigurationView, TintableBackgroundView, TintableCompoundDrawablesView {
    ...
    public AppCompatAutoCompleteTextView(@NonNull Context context0) {
        this(context0, null);
    }

    public AppCompatAutoCompleteTextView(@NonNull Context context0, @Nullable AttributeSet attributeSet0) {
        this(context0, attributeSet0, attr.autoCompleteTextViewStyle);
    }

    public AppCompatAutoCompleteTextView(@NonNull Context context0, @Nullable AttributeSet attributeSet0, int v) {
        super(TintContextWrapper.b(context0), attributeSet0, v);
        ThemeUtils.a(this, this.getContext());
        TintTypedArray tintTypedArray0 = TintTypedArray.G(this.getContext(), attributeSet0, AppCompatAutoCompleteTextView.d, v, 0);
