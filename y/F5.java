...
public final class f5 implements ViewBinding {
    ...
    private f5(@NonNull ConstraintLayout constraintLayout0, @NonNull AppCompatTextView appCompatTextView0, @NonNull TextView textView0, @NonNull ImageView imageView0, @NonNull View view0, @NonNull FrameLayout frameLayout0) {
    ...
    @NonNull
    public static f5 a(@NonNull View view0) {
                ...
                if(((ImageView)view3) != null) {
                    ...
                    if(view4 != null) {
                        ...
                        if(((FrameLayout)view5) != null) {
                            return new f5(((ConstraintLayout)view0), ((AppCompatTextView)view1), ((TextView)view2), ((ImageView)view3), view4, ((FrameLayout)view5));
                        }
                    }
                }
            }
    ...
    @NonNull
    public static f5 c(@NonNull LayoutInflater layoutInflater0) {
        return f5.d(layoutInflater0, null, false);
    }

    @NonNull
    public static f5 d(@NonNull LayoutInflater layoutInflater0, @Nullable ViewGroup viewGroup0, boolean z) {
        View view0 = layoutInflater0.inflate(0x7F0E01F5, viewGroup0, false);  // layout:view_item_lora_type_ai_grid
        if(z) {
