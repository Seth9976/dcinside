...
public class GifImageButton extends ImageButton {
    ...
    public GifImageButton(Context context0) {
        super(context0);
    }

    public GifImageButton(Context context0, AttributeSet attributeSet0) {
        super(context0, attributeSet0);
        this.a(l.c(this, attributeSet0, 0, 0));
    }

    public GifImageButton(Context context0, AttributeSet attributeSet0, int v) {
        super(context0, attributeSet0, v);
        this.a(l.c(this, attributeSet0, v, 0));
    }

    @RequiresApi(21)
    public GifImageButton(Context context0, AttributeSet attributeSet0, int v, int v1) {
