...
public final class a implements WebMessageListener {
    public final WebViewBridgeInterface a;

    public a(WebViewBridgeInterface webViewBridgeInterface0) {
    ...
    public final void onPostMessage(WebView webView0, WebMessageCompat webMessageCompat0, Uri uri0, boolean z, JavaScriptReplyProxy javaScriptReplyProxy0) {
        this.a.onHandleInvocation(webView0, webMessageCompat0, uri0, z, javaScriptReplyProxy0);
    }
}
