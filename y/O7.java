...
public final class o7 implements ViewBinding {
    ...
    @NonNull
    public static o7 a(@NonNull View view0) {
                                        ...
                                        if(((AppCompatImageView)view9) != null) {
                                            ...
                                            if(((ResizeTextView)view10) != null) {
                                                ...
                                                if(((FrameLayout)view11) != null) {
                                                    return new o7(((DividerConstraintLayout)view0), ((TextView)view1), ((ResizeTextView)view2), ((ImageView)view3), ((ResizeTextView)view4), ((ResizeTextView)view5), ((AppCompatImageView)view6), ((ResizeTextView)view7), ((ResizeTextView)view8), ((AppCompatImageView)view9), ((ResizeTextView)view10), ((FrameLayout)view11));
                                                }
                                            }
                                        }
                                    }
    ...
    @NonNull
    public static o7 c(@NonNull LayoutInflater layoutInflater0) {
        return o7.d(layoutInflater0, null, false);
    }

    @NonNull
    public static o7 d(@NonNull LayoutInflater layoutInflater0, @Nullable ViewGroup viewGroup0, boolean z) {
        View view0 = layoutInflater0.inflate(0x7F0E0267, viewGroup0, false);  // layout:view_reply_item_voice2
        if(z) {
