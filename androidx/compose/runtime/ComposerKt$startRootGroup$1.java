...
final class ComposerKt.startRootGroup.1 extends N implements p {
    public static final ComposerKt.startRootGroup.1 e;

    static {
        ComposerKt.startRootGroup.1.e = new ComposerKt.startRootGroup.1();
    }
