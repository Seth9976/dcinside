...
public class h extends k {
    ...
    protected final Object a() {
        ...
        List list0 = updatePackage0.getPatch().getUrlList();
        int v = this.d;
        this.d = v + 1;
    ...
    protected final boolean a(Throwable throwable0) {
        GeckoLogger.w("gecko-debug-tag", "patch update failed", throwable0);
        return this.d < ((UpdatePackage)this.g()).getPatch().getUrlList().size() ? throwable0 instanceof a || throwable0 instanceof b : false;
    }
}
