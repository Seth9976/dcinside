...
public final class AdsProductConstraintLayout extends ConstraintLayout implements AdsWidgetProduct {
    @m
    ...
    @j
    public AdsProductConstraintLayout(@l Context context0) {
        L.p(context0, "context");
        this(context0, null, 0, 6, null);
    }

    @j
    public AdsProductConstraintLayout(@l Context context0, @m AttributeSet attributeSet0) {
        L.p(context0, "context");
        this(context0, attributeSet0, 0, 4, null);
    }

    @j
    public AdsProductConstraintLayout(@l Context context0, @m AttributeSet attributeSet0, int v) {
        L.p(context0, "context");
        super(context0, attributeSet0, v);
        this.products = new LinkedList();
    }

    public AdsProductConstraintLayout(Context context0, AttributeSet attributeSet0, int v, int v1, w w0) {
        if((v1 & 2) != 0) {
            attributeSet0 = null;
        }
        if((v1 & 4) != 0) {
    ...
    protected void onFinishInflate() {
        ...
        q.f(this, false, new Function1() {
            {
                AdsProductConstraintLayout.this = adsProductConstraintLayout0;
                super(1);
            }
            ...
            public final p invoke(@l View view0) {
                ...
                if(view0 instanceof AdsWidgetProduct) {
                    AdsProductConstraintLayout.this.products.add(view0);
                    return p.c;
                }
                return p.a;
            }
