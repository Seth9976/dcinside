...
public final class zzgyw extends LinkedHashMap {
    ...
    public final int hashCode() {
        ...
        for(Object object0: this.entrySet()) {
            int v1 = zzgyw.zzf(((Map.Entry)object0).getKey());
            v += zzgyw.zzf(((Map.Entry)object0).getValue()) ^ v1;
        }
        return v;
    }
    ...
    public final zzgyw zzb() {
        return this.isEmpty() ? new zzgyw() : new zzgyw(this);
    }
    ...
    public final void zzd(zzgyw zzgyw0) {
        this.zzg();
        if(!zzgyw0.isEmpty()) {
            this.putAll(zzgyw0);
        }
    ...
    private static int zzf(Object object0) {
        if(object0 instanceof byte[]) {
            ...
            int v1 = zzgye.zzb(v, ((byte[])object0), 0, v);
            return v1 == 0 ? 1 : v1;
        }
        if(object0 instanceof zzgxv) {
