...
public abstract class FloatFloatMap {
            ...
            while(true) {
                ...
                while(v5 < v4) {
                    if((v3 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)o0.invoke(f, f1)));
                        ++v2;
                    }
                    v3 >>= 8;
                    ++v5;
    ...
    public final String B(@l CharSequence charSequence0) {
        ...
        return FloatFloatMap.L(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String D(@l CharSequence charSequence0, @l CharSequence charSequence1) {
        ...
        return FloatFloatMap.L(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String F(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2) {
        ...
        return FloatFloatMap.L(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String G(@l CharSequence charSequence0, @l CharSequence charSequence1, @l CharSequence charSequence2, int v) {
        ...
        L.p(charSequence1, "prefix");
        L.p(charSequence2, "postfix");
        return FloatFloatMap.L(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
    ...
    public static String L(FloatFloatMap floatFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return floatFloatMap0.I(charSequence0, charSequence5, charSequence4, ((v1 & 8) == 0 ? v : -1), charSequence3);
    }

    public static String M(FloatFloatMap floatFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, o o0, int v1, Object object0) {
        long[] arr_v2;
        long[] arr_v1;
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        float[] arr_f = floatFloatMap0.b;
        float[] arr_f1 = floatFloatMap0.c;
        long[] arr_v = floatFloatMap0.a;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(!((Boolean)o0.invoke(((float)arr_f[v5]), ((float)arr_f1[v5]))).booleanValue()) {
                                return false;
                            }
                        }
                        v2 >>= 8;
    ...
    public boolean equals(@m Object object0) {
        ...
        if(!(object0 instanceof FloatFloatMap)) {
            return false;
        }
        if(((FloatFloatMap)object0).t() != this.t()) {
            return false;
        }
        float[] arr_f = this.b;
        float[] arr_f1 = this.c;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(arr_f1[v5] != ((FloatFloatMap)object0).n(arr_f[v5])) {
                                return false;
                            }
                        }
                        v2 >>= 8;
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            if(((Boolean)o0.invoke(((float)arr_f[v6]), ((float)arr_f1[v6]))).booleanValue()) {
                                ++v2;
                            }
                        }
                        v3 >>= 8;
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            v2 += Float.floatToIntBits(arr_f1[v6]) ^ Float.floatToIntBits(arr_f[v6]);
                        }
                        v3 >>= 8;
                    }
                    if(v4 != 8) {
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            o0.invoke(((float)arr_f[v5]), ((float)arr_f1[v5]));
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final float r(float f, float f1) {
        int v = this.i(f);
        return v < 0 ? f1 : this.c[v];
    }

    public final float s(float f, @l a a0) {
        L.p(a0, "defaultValue");
        int v = this.i(f);
        return v >= 0 ? this.c[v] : ((Number)a0.invoke()).floatValue();
    }
    ...
    public final String z() {
        return FloatFloatMap.L(this, null, null, null, 0, null, 0x1F, null);
    }
}
