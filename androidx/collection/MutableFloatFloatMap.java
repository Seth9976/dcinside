...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    public MutableFloatFloatMap(int v) {
        super(null);
        if(v < 0) {
    ...
    public MutableFloatFloatMap(int v, int v1, w w0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final float S(float f, @y4.l a a0) {
        L.p(a0, "defaultValue");
        int v = this.i(f);
        if(v < 0) {
    ...
    public final void a0(@y4.l FloatFloatMap floatFloatMap0) {
        L.p(floatFloatMap0, "from");
        this.d0(floatFloatMap0);
    }

    public final float b0(float f, float f1, float f2) {
        int v = this.R(f);
        if(v < 0) {
            v = ~v;
        }
    ...
    public final void c0(float f, float f1) {
        this.k0(f, f1);
    }

    public final void d0(@y4.l FloatFloatMap floatFloatMap0) {
        L.p(floatFloatMap0, "from");
    ...
    public final boolean f0(float f, float f1) {
        int v = this.i(f);
        if(v >= 0 && this.c[v] == f1) {
            this.i0(v);
            return true;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)o0.invoke(((float)this.b[v5]), ((float)this.c[v5]))).booleanValue()) {
                                this.i0(v5);
                            }
                        }
                        v2 >>= 8;
    ...
    public final void k0(float f, float f1) {
        int v = this.R(f);
        if(v < 0) {
            v = ~v;
        }
