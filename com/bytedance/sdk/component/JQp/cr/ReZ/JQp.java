...
public class JQp implements xs {
    public static class PjT {
        ...
        public PjT PjT(Owx owx0) {
            this.Au = owx0;
            return this;
        }

        public PjT PjT(RD rD0) {
            this.SM = rD0;
            return this;
        }

        public PjT PjT(Zh zh0) {
            this.XX = zh0;
            return this;
        }

        public PjT PjT(cr cr0) {
            this.ReZ = cr0;
            return this;
        }

        public JQp PjT() {
            return new JQp(this, null);
        }
    }
    ...
    JQp(PjT jQp$PjT0, com.bytedance.sdk.component.JQp.cr.ReZ.JQp.1 jQp$10) {
        this(jQp$PjT0);
    }

    @Override  // com.bytedance.sdk.component.JQp.xs
    public Zh Au() {
        return this.XX;
    }
    ...
    class com.bytedance.sdk.component.JQp.cr.ReZ.JQp.1 {
    }
