...
public final class s implements w {
    ...
    public Animator a(@NonNull ViewGroup viewGroup0, @NonNull View view0) {
        return s.d(viewGroup0, view0, this.a, this.h(view0.getContext()));
    }

    @Override  // com.google.android.material.transition.w
    @Nullable
    public Animator b(@NonNull ViewGroup viewGroup0, @NonNull View view0) {
        return s.c(viewGroup0, view0, this.a, this.h(view0.getContext()));
    }
    ...
    private static Animator c(View view0, View view1, int v, @Px int v1) {
        ...
        switch(v) {
            case 3: {
                return s.e(view1, ((float)v1) + f, f, f);
            }
            case 5: {
                return s.e(view1, f - ((float)v1), f, f);
            }
            case 0x30: {
                return s.f(view1, f1 - ((float)v1), f1, f1);
            }
            case 80: {
                return s.f(view1, ((float)v1) + f1, f1, f1);
            }
            case 0x800003: {
                return s.j(view0) ? s.e(view1, ((float)v1) + f, f, f) : s.e(view1, f - ((float)v1), f, f);
            }
            case 0x800005: {
                return s.j(view0) ? s.e(view1, f - ((float)v1), f, f) : s.e(view1, ((float)v1) + f, f, f);
            }
            default: {
    ...
    private static Animator d(View view0, View view1, int v, @Px int v1) {
        ...
        switch(v) {
            case 3: {
                return s.e(view1, f, f - ((float)v1), f);
            }
            case 5: {
                return s.e(view1, f, ((float)v1) + f, f);
            }
            ...
            case 80: {
                return s.f(view1, f1, f1 - ((float)v1), f1);
            }
            case 0x800003: {
                return s.j(view0) ? s.e(view1, f, f - ((float)v1), f) : s.e(view1, f, ((float)v1) + f, f);
            }
            case 0x800005: {
                return s.j(view0) ? s.e(view1, f, ((float)v1) + f, f) : s.e(view1, f, f - ((float)v1), f);
            }
            default: {
                throw new IllegalArgumentException("Invalid slide direction: " + v);
            }
