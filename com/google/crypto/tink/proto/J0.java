...
public final class j0 extends l0 implements m0 {
    static class a {
        static final int[] a;
    ...
    public static final class b extends com.google.crypto.tink.shaded.protobuf.l0.b implements m0 {
        private b() {
        ...
        @Override  // com.google.crypto.tink.proto.m0
        public u c() {
            return ((j0)this.b).c();
        }
    ...
    private static final j0 DEFAULT_INSTANCE = null;
    ...
    protected final Object C1(i l0$i0, Object object0, Object object1) {
        switch(l0$i0) {
            ...
            case 3: {
                return l0.e2(j0.DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\u000B\u0002\n", new Object[]{"version_", "keyValue_"});
            }
            case 4: {
    ...
    public static b L2() {
        return (b)j0.DEFAULT_INSTANCE.y1();
    }

    public static b M2(j0 j00) {
        return (b)j0.DEFAULT_INSTANCE.z1(j00);
    }

    public static j0 N2(InputStream inputStream0) throws IOException {
        return (j0)l0.i2(j0.DEFAULT_INSTANCE, inputStream0);
    }

    public static j0 O2(InputStream inputStream0, V v0) throws IOException {
        return (j0)l0.j2(j0.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static j0 P2(u u0) throws y0 {
        return (j0)l0.k2(j0.DEFAULT_INSTANCE, u0);
    }

    public static j0 Q2(u u0, V v0) throws y0 {
        return (j0)l0.l2(j0.DEFAULT_INSTANCE, u0, v0);
    }

    public static j0 R2(z z0) throws IOException {
        return (j0)l0.m2(j0.DEFAULT_INSTANCE, z0);
    }

    public static j0 S2(z z0, V v0) throws IOException {
        return (j0)l0.n2(j0.DEFAULT_INSTANCE, z0, v0);
    }

    public static j0 T2(InputStream inputStream0) throws IOException {
        return (j0)l0.o2(j0.DEFAULT_INSTANCE, inputStream0);
    }

    public static j0 U2(InputStream inputStream0, V v0) throws IOException {
        return (j0)l0.p2(j0.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static j0 V2(ByteBuffer byteBuffer0) throws y0 {
        return (j0)l0.q2(j0.DEFAULT_INSTANCE, byteBuffer0);
    }

    public static j0 W2(ByteBuffer byteBuffer0, V v0) throws y0 {
        return (j0)l0.r2(j0.DEFAULT_INSTANCE, byteBuffer0, v0);
    }

    public static j0 X2(byte[] arr_b) throws y0 {
        return (j0)l0.s2(j0.DEFAULT_INSTANCE, arr_b);
    }

    public static j0 Y2(byte[] arr_b, V v0) throws y0 {
        return (j0)l0.t2(j0.DEFAULT_INSTANCE, arr_b, v0);
    }

    public static j1 Z2() {
        return j0.DEFAULT_INSTANCE.getParserForType();
    }
