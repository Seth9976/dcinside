...
public class XX implements View.OnTouchListener {
    ...
    public XX(Au au0, int v, ViewGroup viewGroup0) {
        this.JQp = XX.ReZ;
        this.cz = new RectF();
        this.XX = 0L;
        this.Au = 200;
        ...
        if(viewGroup0 != null) {
            viewGroup0.post(new Runnable() {
                ...
                @Override
                public void run() {
                    SoftReference softReference0 = new SoftReference(viewGroup0.findViewById(0x7D06FFFA));
                    XX.this.DWo = softReference0;
                }
            });
        }
    }
    ...
    public boolean onTouch(View view0, MotionEvent motionEvent0) {
        switch(motionEvent0.getAction()) {
            ...
            case 1: {
                ...
                int v = com.bytedance.sdk.component.adexpress.cr.XX.Zh(cr.PjT(), Math.abs(f - this.PjT));
                if(f2 >= ((float)XX.ReZ) && f3 >= ((float)XX.ReZ)) {
                    if(f > this.PjT && v > this.JQp) {
                        Au au0 = this.cr;
                        if(au0 != null) {
                            au0.PjT();
                            return true;
