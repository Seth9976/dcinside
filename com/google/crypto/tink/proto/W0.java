...
public final class w0 extends l0 implements x0 {
    static class a {
        static final int[] a;
    ...
    public static final class b extends com.google.crypto.tink.shaded.protobuf.l0.b implements x0 {
        private b() {
        ...
        public b T1(com.google.crypto.tink.proto.y0 y00) {
            this.F1();
            ((w0)this.b).P2(y00);
            return this;
        }
        ...
        public b V1(com.google.crypto.tink.proto.y0.b y0$b0) {
            this.F1();
            ((w0)this.b).g3(((com.google.crypto.tink.proto.y0)y0$b0.B1()));
            return this;
        }

        public b W1(com.google.crypto.tink.proto.y0 y00) {
            this.F1();
            ((w0)this.b).g3(y00);
            return this;
        }
        ...
        @Override  // com.google.crypto.tink.proto.x0
        public com.google.crypto.tink.proto.y0 e() {
            return ((w0)this.b).e();
        }
    ...
    private static final w0 DEFAULT_INSTANCE = null;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    private static volatile j1 PARSER = null;
    public static final int PUBLIC_KEY_FIELD_NUMBER = 2;
    public static final int VERSION_FIELD_NUMBER = 1;
    private u keyValue_;
    private com.google.crypto.tink.proto.y0 publicKey_;
    private int version_;

    static {
        w0 w00 = new w0();
        w0.DEFAULT_INSTANCE = w00;
        l0.A2(w0.class, w00);
    }
    ...
    protected final Object C1(i l0$i0, Object object0, Object object1) {
        switch(l0$i0) {
            ...
            case 3: {
                return l0.e2(w0.DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001\u000B\u0002\t\u0003\n", new Object[]{"version_", "publicKey_", "keyValue_"});
            }
            case 4: {
                return w0.DEFAULT_INSTANCE;
            }
            case 5: {
                j1 j10 = w0.PARSER;
                if(j10 == null) {
    ...
    private void P2(com.google.crypto.tink.proto.y0 y00) {
        y00.getClass();
        if(this.publicKey_ != null && this.publicKey_ != com.google.crypto.tink.proto.y0.R2()) {
            this.publicKey_ = (com.google.crypto.tink.proto.y0)((com.google.crypto.tink.proto.y0.b)com.google.crypto.tink.proto.y0.U2(this.publicKey_).K1(y00)).C1();
            return;
        }
        this.publicKey_ = y00;
    }
    ...
    public static b Q2() {
        return (b)w0.DEFAULT_INSTANCE.y1();
    }

    public static b R2(w0 w00) {
        return (b)w0.DEFAULT_INSTANCE.z1(w00);
    }

    public static w0 S2(InputStream inputStream0) throws IOException {
        return (w0)l0.i2(w0.DEFAULT_INSTANCE, inputStream0);
    }

    public static w0 T2(InputStream inputStream0, V v0) throws IOException {
        return (w0)l0.j2(w0.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static w0 U2(u u0) throws y0 {
        return (w0)l0.k2(w0.DEFAULT_INSTANCE, u0);
    }

    public static w0 V2(u u0, V v0) throws y0 {
        return (w0)l0.l2(w0.DEFAULT_INSTANCE, u0, v0);
    }

    public static w0 W2(z z0) throws IOException {
        return (w0)l0.m2(w0.DEFAULT_INSTANCE, z0);
    }

    public static w0 X2(z z0, V v0) throws IOException {
        return (w0)l0.n2(w0.DEFAULT_INSTANCE, z0, v0);
    }

    public static w0 Y2(InputStream inputStream0) throws IOException {
        return (w0)l0.o2(w0.DEFAULT_INSTANCE, inputStream0);
    }

    public static w0 Z2(InputStream inputStream0, V v0) throws IOException {
        return (w0)l0.p2(w0.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static w0 a3(ByteBuffer byteBuffer0) throws y0 {
        return (w0)l0.q2(w0.DEFAULT_INSTANCE, byteBuffer0);
    }

    public static w0 b3(ByteBuffer byteBuffer0, V v0) throws y0 {
        return (w0)l0.r2(w0.DEFAULT_INSTANCE, byteBuffer0, v0);
    }
    ...
    public static w0 c3(byte[] arr_b) throws y0 {
        return (w0)l0.s2(w0.DEFAULT_INSTANCE, arr_b);
    }

    public static w0 d3(byte[] arr_b, V v0) throws y0 {
        return (w0)l0.t2(w0.DEFAULT_INSTANCE, arr_b, v0);
    }

    @Override  // com.google.crypto.tink.proto.x0
    public com.google.crypto.tink.proto.y0 e() {
        return this.publicKey_ == null ? com.google.crypto.tink.proto.y0.R2() : this.publicKey_;
    }

    public static j1 e3() {
        return w0.DEFAULT_INSTANCE.getParserForType();
    }
    ...
    private void g3(com.google.crypto.tink.proto.y0 y00) {
        y00.getClass();
        this.publicKey_ = y00;
    }
