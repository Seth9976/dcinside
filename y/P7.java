...
public final class p7 implements ViewBinding {
    ...
    public final View m;
    @NonNull
    public final ResizeTextView n;
    @NonNull
    public final ImageView o;
    @NonNull
    public final SmoothProgressBar p;

    private p7(@NonNull DividerConstraintLayout dividerConstraintLayout0, @NonNull TextView textView0, @NonNull ResizeTextView resizeTextView0, @NonNull ImageView imageView0, @NonNull ResizeTextView resizeTextView1, @NonNull ResizeTextView resizeTextView2, @NonNull AppCompatImageView appCompatImageView0, @NonNull ResizeTextView resizeTextView3, @NonNull ResizeTextView resizeTextView4, @NonNull AppCompatImageView appCompatImageView1, @NonNull ResizeTextView resizeTextView5, @NonNull FrameLayout frameLayout0, @NonNull View view0, @NonNull ResizeTextView resizeTextView6, @NonNull ImageView imageView1, @NonNull SmoothProgressBar smoothProgressBar0) {
        ...
        this.l = frameLayout0;
        this.m = view0;
        this.n = resizeTextView6;
        this.o = imageView1;
        this.p = smoothProgressBar0;
    }

    @NonNull
    public static p7 a(@NonNull View view0) {
                                    ...
                                    if(((ResizeTextView)view8) != null) {
                                        ...
                                        if(((AppCompatImageView)view9) != null) {
                                            ...
                                            if(((ResizeTextView)view10) != null) {
                                                v = 0x7F0B0D75;  // id:reply_voice
                                                View view11 = ViewBindings.a(view0, 0x7F0B0D75);  // id:reply_voice
                                                if(((FrameLayout)view11) != null) {
                                                    v = 0x7F0B0D76;  // id:reply_voice_cover
                                                    View view12 = ViewBindings.a(view0, 0x7F0B0D76);  // id:reply_voice_cover
                                                    if(view12 != null) {
                                                        v = 0x7F0B0D77;  // id:reply_voice_desc
                                                        View view13 = ViewBindings.a(view0, 0x7F0B0D77);  // id:reply_voice_desc
                                                        if(((ResizeTextView)view13) != null) {
                                                            v = 0x7F0B0D78;  // id:reply_voice_play
                                                            View view14 = ViewBindings.a(view0, 0x7F0B0D78);  // id:reply_voice_play
                                                            if(((ImageView)view14) != null) {
                                                                v = 0x7F0B0D79;  // id:reply_voice_progress
                                                                View view15 = ViewBindings.a(view0, 0x7F0B0D79);  // id:reply_voice_progress
                                                                if(((SmoothProgressBar)view15) != null) {
                                                                    return new p7(((DividerConstraintLayout)view0), ((TextView)view1), ((ResizeTextView)view2), ((ImageView)view3), ((ResizeTextView)view4), ((ResizeTextView)view5), ((AppCompatImageView)view6), ((ResizeTextView)view7), ((ResizeTextView)view8), ((AppCompatImageView)view9), ((ResizeTextView)view10), ((FrameLayout)view11), view12, ((ResizeTextView)view13), ((ImageView)view14), ((SmoothProgressBar)view15));
                                                                }
                                                            }
                                                        }
                                                    }
    ...
    @NonNull
    public static p7 c(@NonNull LayoutInflater layoutInflater0) {
        return p7.d(layoutInflater0, null, false);
    }

    @NonNull
    public static p7 d(@NonNull LayoutInflater layoutInflater0, @Nullable ViewGroup viewGroup0, boolean z) {
        View view0 = layoutInflater0.inflate(0x7F0E0266, viewGroup0, false);  // layout:view_reply_item_voice
        if(z) {
