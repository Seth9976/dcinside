...
public abstract class CloudMessagingReceiver extends BroadcastReceiver {
    ...
    @WorkerThread
    protected abstract int onMessageReceive(@NonNull Context arg1, @NonNull CloudMessage arg2);
    ...
    public final void onReceive(@NonNull Context context0, @NonNull Intent intent0) {
        ...
        this.getBroadcastExecutor().execute(() -> {
            int v1;
            try {
    ...
    // 检测为 Lambda 实现
    final void zza(Intent intent0, Context context0, boolean z, BroadcastReceiver.PendingResult broadcastReceiver$PendingResult0) [...]

    @WorkerThread
    private final int zzb(@NonNull Context context0, @NonNull Intent intent0) {
