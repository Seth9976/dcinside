...
public class e extends d {
    ...
    public final Object a(b b0, Object object0) throws Throwable {
        GeckoLogger.d("gecko-debug-tag", new Object[]{"start active merged single file,channel:", ((UpdatePackage)((Pair)object0).second).getChannel()});
        File file0 = ((File)((Pair)object0).first).getParentFile().getParentFile();
        ...
        if(!file0.renameTo(file1)) {
            throw new RuntimeException("active merged single file failed:" + file0.getAbsolutePath());
        }
