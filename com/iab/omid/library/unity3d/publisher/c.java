...
public class c extends a {
    ...
    void A() {
        class com.iab.omid.library.unity3d.publisher.c.a extends WebViewClient {
            final c a;
        ...
        WebView webView0 = new WebView(f.c().a());
        this.g = webView0;
        webView0.getSettings().setJavaScriptEnabled(true);
        this.g.getSettings().setAllowContentAccess(false);
        this.g.getSettings().setAllowFileAccess(false);
        this.g.setWebViewClient(new com.iab.omid.library.unity3d.publisher.c.a(this));
        this.c(this.g);
        g.a().q(this.g, this.j);
        for(Object object0: this.i.keySet()) {
            String s = ((o)this.i.get(((String)object0))).c().toExternalForm();
            g.a().p(this.g, s, ((String)object0));
        }
        this.h = 9375229440800L;
    }
    ...
    public void g(p p0, d d0) {
        ...
        for(Object object0: map0.keySet()) {
            com.iab.omid.library.unity3d.utils.c.i(jSONObject0, ((String)object0), ((o)map0.get(((String)object0))).f());
        }
        this.h(p0, d0, jSONObject0);
    }
    ...
    public void p() {
        ...
        super.p();
        long v = this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(9375226571400L - ((long)this.h), TimeUnit.NANOSECONDS);
