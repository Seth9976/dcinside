...
public final class zzagk extends zzagh {
    ...
    static {
        zzagk.CREATOR = new zzagj();
    }

    zzagk(Parcel parcel0) {
        super("----");
    ...
    public zzagk(String s, String s1, String s2) {
        super("----");
        this.zza = s;
        this.zzb = s1;
        this.zzc = s2;
    ...
    public final boolean equals(@Nullable Object object0) {
        ...
        if(object0 != null) {
            ...
            return zzagk.class == class0 && Objects.equals(this.zzb, ((zzagk)object0).zzb) && Objects.equals(this.zza, ((zzagk)object0).zza) && Objects.equals(this.zzc, ((zzagk)object0).zzc);
        }
        return false;
    }
