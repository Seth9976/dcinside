...
final class zzjd extends zzhj implements zzjl, zzkw, RandomAccess {
    ...
    static {
        zzjd zzjd0 = new zzjd(new int[0], 0);
        zzjd.zza = zzjd0;
        zzjd0.zzb();
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzjd)) {
            return super.addAll(collection0);
        }
        int v = ((zzjd)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzjd)collection0).zzb, 0, this.zzb, this.zzc, ((zzjd)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.zzc != ((zzjd)object0).zzc) {
            return false;
        }
        int[] arr_v = ((zzjd)object0).zzb;
    ...
    public final zzjl zza(int v) {
        ...
        return new zzjd(Arrays.copyOf(this.zzb, v), this.zzc);
    }
