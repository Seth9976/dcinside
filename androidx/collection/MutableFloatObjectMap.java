...
public final class MutableFloatObjectMap extends FloatObjectMap {
    ...
    public MutableFloatObjectMap(int v, int v1, w w0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final Object S(float f, @y4.l a a0) {
        L.p(a0, "defaultValue");
    ...
    public final void a0(@y4.l FloatObjectMap floatObjectMap0) {
        L.p(floatObjectMap0, "from");
        this.c0(floatObjectMap0);
    }

    @m
    public final Object b0(float f, Object object0) {
        int v = this.Q(f);
    ...
    public final void c0(@y4.l FloatObjectMap floatObjectMap0) {
        L.p(floatObjectMap0, "from");
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            this.j0(arr_f[v5], arr_object[v5]);
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    @m
    public final Object d0(float f) {
        int v = Float.floatToIntBits(f);
        int v1 = v * 0xCC9E2D51 ^ v * 0xCC9E2D51 << 16;
        int v2 = this.d;
        int v3 = v1 >>> 7 & v2;
    ...
    public final boolean e0(float f, Object object0) {
        int v10;
        int v = Float.floatToIntBits(f);
        int v1 = v * 0xCC9E2D51 ^ v * 0xCC9E2D51 << 16;
        int v2 = this.d;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)o0.invoke(((float)this.b[v5]), this.c[v5])).booleanValue()) {
                                this.h0(v5);
                            }
                        }
                        v2 >>= 8;
    ...
    public final void j0(float f, Object object0) {
        int v = this.Q(f);
        this.b[v] = f;
        this.c[v] = object0;
    }
