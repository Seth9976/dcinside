...
public class ModuleInstallStatusUpdate extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    @Constructor
    public ModuleInstallStatusUpdate(@Param(id = 1) int v, @Param(id = 2) @InstallState int v1, @Nullable @Param(id = 3) Long long0, @Nullable @Param(id = 4) Long long1, @Param(id = 5) int v2) {
        this.zaa = v;
        this.zab = v1;
        this.zac = long0;
        this.zad = long1;
