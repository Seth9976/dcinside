...
public class u extends t {
    ...
    protected u(com.fasterxml.jackson.databind.cfg.t t0, m m0, ConcurrentHashMap concurrentHashMap0, HashMap hashMap0) {
        super(m0, t0.S());
        this.c = t0;
    ...
    public static u j(com.fasterxml.jackson.databind.cfg.t t0, m m0, Collection collection0, boolean z, boolean z1) {
        HashMap hashMap0;
        ...
        if(collection0 != null) {
            for(Object object0: collection0) {
                c c0 = (c)object0;
                Class class0 = c0.a();
                String s = c0.b() ? c0.getName() : u.h(class0);
                if(z) {
        ...
        return new u(t0, m0, concurrentHashMap0, hashMap0);
    }
