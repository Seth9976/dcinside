...
public final class NavType.Companion.LongArrayType.1 extends NavType {
    ...
    public void l(@l Bundle bundle0, @l String s, @m long[] arr_v) {
        L.p(bundle0, "bundle");
        L.p(s, "key");
