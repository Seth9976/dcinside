package com.bytedance.sdk.component.JQp.ReZ.Zh;
...
public class PjT {
    ...
    private static int PjT(int v, int v1, int v2, int v3, ImageView.ScaleType imageView$ScaleType0) {
        if(v == 0 && v1 == 0) {
            return v2;
        }
    ...
    public Bitmap PjT(byte[] arr_b) {
        ...
        if(this.cr != 0 || this.JQp != 0) {
            ...
            int v2 = PjT.PjT(this.cr, this.JQp, v, v1, this.Au);
            int v3 = PjT.PjT(this.JQp, this.cr, v1, v, this.Au);
            bitmapFactory$Options0.inJustDecodeBounds = false;
            bitmapFactory$Options0.inSampleSize = PjT.PjT(v, v1, v2, v3, this.cz, this.XX);
        ...
        if(bitmap0 != null && bitmap0.getByteCount() > 0x6400000) {
            int v4 = bitmap0.getWidth();
            int v5 = bitmap0.getHeight();
            if(v4 / 2 > 0 && v5 / 2 > 0) {
                Bitmap bitmap2 = Bitmap.createScaledBitmap(bitmap0, v4 / 2, v5 / 2, true);
                if(bitmap2 != bitmap0) {
                    bitmap0.recycle();
                }
                return bitmap2;
