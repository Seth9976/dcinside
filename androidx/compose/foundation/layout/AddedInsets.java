...
final class AddedInsets implements WindowInsets {
    ...
    public AddedInsets(@l WindowInsets windowInsets0, @l WindowInsets windowInsets1) {
    ...
    public int a(@l Density density0) {
        ...
        return this.b.a(density0) + this.c.a(density0);
    }
    ...
    public int b(@l Density density0, @l LayoutDirection layoutDirection0) {
        ...
        return this.b.b(density0, layoutDirection0) + this.c.b(density0, layoutDirection0);
    }

    @Override  // androidx.compose.foundation.layout.WindowInsets
    public int c(@l Density density0) {
        L.p(density0, "density");
        return this.b.c(density0) + this.c.c(density0);
    }
    ...
    public int d(@l Density density0, @l LayoutDirection layoutDirection0) {
        L.p(density0, "density");
        L.p(layoutDirection0, "layoutDirection");
        return this.b.d(density0, layoutDirection0) + this.c.d(density0, layoutDirection0);
    }
    ...
    public boolean equals(@m Object object0) {
        ...
        return object0 instanceof AddedInsets ? L.g(((AddedInsets)object0).b, this.b) && L.g(((AddedInsets)object0).c, this.c) : false;
    }
