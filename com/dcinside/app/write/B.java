...
@s0({"SMAP\nAutoImageRequestListener.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AutoImageRequestListener.kt\ncom/dcinside/app/write/AutoImageRequestListener\n+ 2 ViewExtension.kt\ncom/dcinside/app/internal/ViewExtensionKt\n*L\n1#1,56:1\n147#2:57\n*S KotlinDebug\n*F\n+ 1 AutoImageRequestListener.kt\ncom/dcinside/app/write/AutoImageRequestListener\n*L\n22#1:57\n*E\n"})
public final class b implements h {
    ...
    public b(@l A1 a10, int v, int v1, @l String s) {
        L.p(a10, "holder");
        L.p(s, "size");
        super();
        this.a = v;
    ...
    public boolean d(@l Drawable drawable0, @l Object object0, @m p p0, @l a a0, boolean z) {
        ...
        a10.d0((this.a == 0 ? drawable0.getIntrinsicWidth() : this.a), (this.b == 0 ? drawable0.getIntrinsicHeight() : this.b), this.c);
        return false;
    }
    ...
    public boolean onLoadFailed(@m q q0, @m Object object0, @l p p0, boolean z) {
        ...
        ImageView imageView0 = a10.X();
        String s = object0 instanceof Uri ? ((Uri)object0).getPath() : null;
        a10.a0().setText((s == null || !v.v2(s, "http", false, 2, null) ? 0x7F15031E : 0x7F1504CE));  // string:failed_image_deleted "해당 기기의 이미지가 삭제되었습니다."
