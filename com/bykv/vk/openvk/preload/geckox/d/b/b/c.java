...
public class c extends d {
    ...
    private Object a(com.bykv.vk.openvk.preload.b.b b0, Pair pair0) throws Throwable {
        GeckoLogger.d("gecko-debug-tag", new Object[]{"start download patch zip file, channel:", ((UpdatePackage)pair0.second).getChannel()});
        ...
        try {
            ...
            throw new com.bykv.vk.openvk.preload.geckox.b.a("download patch zip failed, url:" + s + ", channel:" + updatePackage0.getChannel() + ", pkg id:" + updatePackage0.getPatch().getId() + ", caused by:" + throwable0.getMessage(), throwable0);
        }
        finally {
            a0.e();
        }
