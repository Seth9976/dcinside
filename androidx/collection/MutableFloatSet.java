...
public final class MutableFloatSet extends FloatSet {
    ...
    public MutableFloatSet(int v, int v1, w w0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final boolean H(@l FloatSet floatSet0) {
        L.p(floatSet0, "elements");
        int v = this.d;
        this.U(floatSet0);
        return v != this.d;
    }

    public final boolean I(@l float[] arr_f) {
        L.p(arr_f, "elements");
        int v = this.d;
        this.V(arr_f);
        return v != this.d;
    ...
    public final void R(@l FloatSet floatSet0) {
        L.p(floatSet0, "elements");
    ...
    public final void S(@l float[] arr_f) {
        L.p(arr_f, "elements");
    ...
    public final void U(@l FloatSet floatSet0) {
        L.p(floatSet0, "elements");
        float[] arr_f = floatSet0.b;
        long[] arr_v = floatSet0.a;
        int v = arr_v.length - 2;
    ...
    public final void V(@l float[] arr_f) {
        L.p(arr_f, "elements");
        for(int v = 0; v < arr_f.length; ++v) {
            this.T(arr_f[v]);
        }
    ...
    public final boolean X(@l FloatSet floatSet0) {
        L.p(floatSet0, "elements");
        int v = this.d;
        this.R(floatSet0);
        return v != this.d;
    ...
    public final boolean Y(@l float[] arr_f) {
        L.p(arr_f, "elements");
        int v = this.d;
        this.S(arr_f);
        return v != this.d;
