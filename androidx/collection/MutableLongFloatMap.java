...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    public MutableLongFloatMap(int v, int v1, w w0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final float S(long v, @y4.l a a0) {
        L.p(a0, "defaultValue");
        int v1 = this.i(v);
        if(v1 < 0) {
    ...
    public final void a0(@y4.l LongFloatMap longFloatMap0) {
        L.p(longFloatMap0, "from");
        this.d0(longFloatMap0);
    }

    public final float b0(long v, float f, float f1) {
        int v1 = this.R(v);
        if(v1 < 0) {
            v1 = ~v1;
        }
    ...
    public final void c0(long v, float f) {
        this.k0(v, f);
    }

    public final void d0(@y4.l LongFloatMap longFloatMap0) {
        L.p(longFloatMap0, "from");
    ...
    public final boolean f0(long v, float f) {
        int v1 = this.i(v);
        if(v1 >= 0 && this.c[v1] == f) {
            this.i0(v1);
            return true;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)o0.invoke(((long)this.b[v5]), ((float)this.c[v5]))).booleanValue()) {
                                this.i0(v5);
                            }
                        }
                        v2 >>= 8;
    ...
    public final void k0(long v, float f) {
        int v1 = this.R(v);
        if(v1 < 0) {
            v1 = ~v1;
        }
