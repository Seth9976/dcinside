...
public final class a7 implements ViewBinding {
    ...
    @NonNull
    public static a7 a(@NonNull View view0) {
                                    ...
                                    if(((LinearLayout)view8) != null) {
                                        ...
                                        if(((TextView)view9) != null) {
                                            ...
                                            if(((StateAnnounceView)view10) != null) {
                                                return new a7(((FrameLayout)view0), ((ImageView)view1), ((MenuPageIndicator)view2), ((TextView)view3), ((RecyclerViewPager)view4), ((FrameLayout)view5), ((RecyclerView)view6), ((TextView)view7), ((LinearLayout)view8), ((TextView)view9), ((StateAnnounceView)view10));
                                            }
                                        }
                                    }
                                }
    ...
    @NonNull
    public static a7 c(@NonNull LayoutInflater layoutInflater0) {
        return a7.d(layoutInflater0, null, false);
    }

    @NonNull
    public static a7 d(@NonNull LayoutInflater layoutInflater0, @Nullable ViewGroup viewGroup0, boolean z) {
        View view0 = layoutInflater0.inflate(0x7F0E0258, viewGroup0, false);  // layout:view_recent_basic
        if(z) {
