...
public final class b0 extends l0 implements c0 {
    ...
    protected final Object C1(i l0$i0, Object object0, Object object1) {
        switch(l0$i0) {
            ...
            case 3: {
                return l0.e2(b0.DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\u000B\u0002\u000B", new Object[]{"version_", "keySize_"});
            }
            case 4: {
    ...
    public static b M2(b0 b00) {
        return (b)b0.DEFAULT_INSTANCE.z1(b00);
    }

    public static b0 N2(InputStream inputStream0) throws IOException {
        return (b0)l0.i2(b0.DEFAULT_INSTANCE, inputStream0);
    }

    public static b0 O2(InputStream inputStream0, V v0) throws IOException {
        return (b0)l0.j2(b0.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static b0 P2(u u0) throws y0 {
        return (b0)l0.k2(b0.DEFAULT_INSTANCE, u0);
    }

    public static b0 Q2(u u0, V v0) throws y0 {
        return (b0)l0.l2(b0.DEFAULT_INSTANCE, u0, v0);
    }

    public static b0 R2(z z0) throws IOException {
        return (b0)l0.m2(b0.DEFAULT_INSTANCE, z0);
    }

    public static b0 S2(z z0, V v0) throws IOException {
        return (b0)l0.n2(b0.DEFAULT_INSTANCE, z0, v0);
    }

    public static b0 T2(InputStream inputStream0) throws IOException {
        return (b0)l0.o2(b0.DEFAULT_INSTANCE, inputStream0);
    }

    public static b0 U2(InputStream inputStream0, V v0) throws IOException {
        return (b0)l0.p2(b0.DEFAULT_INSTANCE, inputStream0, v0);
    }

    public static b0 V2(ByteBuffer byteBuffer0) throws y0 {
        return (b0)l0.q2(b0.DEFAULT_INSTANCE, byteBuffer0);
    }

    public static b0 W2(ByteBuffer byteBuffer0, V v0) throws y0 {
        return (b0)l0.r2(b0.DEFAULT_INSTANCE, byteBuffer0, v0);
    }

    public static b0 X2(byte[] arr_b) throws y0 {
        return (b0)l0.s2(b0.DEFAULT_INSTANCE, arr_b);
    }

    public static b0 Y2(byte[] arr_b, V v0) throws y0 {
