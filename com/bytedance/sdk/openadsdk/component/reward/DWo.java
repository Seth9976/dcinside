...
public class DWo {
    public static void PjT(String s, int v, String s1, String s2, String s3) {
        try {
            ...
            if(owx0 != null) {
                ...
                if(owx0.uQg() != null) {
                    if(TextUtils.isEmpty(s1)) {
                        ...
                        owx0.uQg().PjT(s1);
                        owx0.uQg().Zh("Test the downloaded app");
                    }
                    if(TextUtils.isEmpty(s1)) {
                        s1 = s3;
                    }
            ...
            arrayList0.add(owx0);
            pjT0.PjT(arrayList0);
            new fDm(ub.PjT(), pjT0).PjT(true);
            return;
        }
        catch(Exception exception0) {
        }
        RD.Zh("PlayableVerityHelper", exception0.getMessage());
    }
}
