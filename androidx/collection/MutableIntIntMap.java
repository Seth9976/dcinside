...
public final class MutableIntIntMap extends IntIntMap {
    ...
    public MutableIntIntMap(int v, int v1, w w0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final int S(int v, @y4.l a a0) {
        L.p(a0, "defaultValue");
        int v1 = this.i(v);
        if(v1 < 0) {
            int v2 = ((Number)a0.invoke()).intValue();
            this.c0(v, v2);
            return v2;
        }
        return this.c[v1];
    ...
    public final void a0(@y4.l IntIntMap intIntMap0) {
        L.p(intIntMap0, "from");
        this.d0(intIntMap0);
    }

    public final int b0(int v, int v1, int v2) {
        int v3 = this.R(v);
        if(v3 < 0) {
            v3 = ~v3;
        }
    ...
    public final void d0(@y4.l IntIntMap intIntMap0) {
        L.p(intIntMap0, "from");
    ...
    public final boolean f0(int v, int v1) {
        int v2 = this.i(v);
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)o0.invoke(((int)this.b[v5]), ((int)this.c[v5]))).booleanValue()) {
                                this.i0(v5);
                            }
                        }
                        v2 >>= 8;
