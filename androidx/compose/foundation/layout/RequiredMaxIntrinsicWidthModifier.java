...
final class RequiredMaxIntrinsicWidthModifier implements IntrinsicSizeModifier {
    @l
    public static final RequiredMaxIntrinsicWidthModifier a;
    private static final boolean b;

    static {
        RequiredMaxIntrinsicWidthModifier.a = new RequiredMaxIntrinsicWidthModifier();
    }

    @Override  // androidx.compose.foundation.layout.IntrinsicSizeModifier
    public boolean F1() {
        return RequiredMaxIntrinsicWidthModifier.b;
    }
    ...
    public int g(IntrinsicMeasureScope intrinsicMeasureScope0, IntrinsicMeasurable intrinsicMeasurable0, int v) {
        return IntrinsicSizeModifier.-CC.e(this, intrinsicMeasureScope0, intrinsicMeasurable0, v);
    }
    ...
    public long u1(@l MeasureScope measureScope0, @l Measurable measurable0, long v) {
        ...
        int v1 = measurable0.h1(Constraints.o(v));
        return Constraints.b.e(v1);
    }
}
