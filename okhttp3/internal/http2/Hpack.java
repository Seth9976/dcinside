...
public final class Hpack {
    public static final class Reader {
        ...
        @j
        public Reader(@l o0 o00, int v) {
            L.p(o00, "source");
            this(o00, v, 0, 4, null);
        }

        @j
        public Reader(@l o0 o00, int v, int v1) {
            L.p(o00, "source");
            super();
        ...
        public Reader(o0 o00, int v, int v1, int v2, w w0) {
            if((v2 & 4) != 0) {
                v1 = v;
            }
            this(o00, v, v1);
        ...
        private final void clearDynamicTable() {
            kotlin.collections.l.V1(this.dynamicTable, null, 0, 0, 6, null);
        ...
        public final List getAndResetHeaderList() {
            List list0 = u.V5(this.headerList);
            this.headerList.clear();
            return list0;
        }

        private final o getName(int v) throws IOException {
        ...
        public final o readByteString() throws IOException {
            ...
            if((v & 0x80) == 0x80) {
                ...
                Huffman.INSTANCE.decode(this.source, v1, l0);
                return l0.B1();
            }
            return this.source.F0(v1);
        }

        public final void readHeaders() throws IOException {
            while(!this.source.j3()) {
        ...
        private final void readLiteralHeaderWithIncrementalIndexingNewName() throws IOException {
            o o0 = this.readByteString();
            this.insertIntoDynamicTable(-1, new Header(Hpack.INSTANCE.checkLowercase(o0), this.readByteString()));
        }
        ...
        private final void readLiteralHeaderWithoutIndexingNewName() throws IOException {
            o o0 = this.readByteString();
            Header header0 = new Header(Hpack.INSTANCE.checkLowercase(o0), this.readByteString());
            this.headerList.add(header0);
        }
    }
    ...
    public static final class Writer {
        ...
        @j
        public Writer(int v, @l okio.l l0) {
            L.p(l0, "out");
            this(v, false, l0, 2, null);
        }

        @j
        public Writer(int v, boolean z, @l okio.l l0) {
            L.p(l0, "out");
            super();
            this.headerTableSizeSetting = v;
        ...
        public Writer(int v, boolean z, okio.l l0, int v1, w w0) {
            if((v1 & 1) != 0) {
                v = 0x1000;
            }
            if((v1 & 2) != 0) {
        ...
        @j
        public Writer(@l okio.l l0) {
            L.p(l0, "out");
            this(0, false, l0, 3, null);
        }
        ...
        public final void writeByteString(@l o o0) throws IOException {
            L.p(o0, "data");
            if(this.useCompression) {
                Huffman huffman0 = Huffman.INSTANCE;
                if(huffman0.encodedLength(o0) < o0.h0()) {
                    okio.l l0 = new okio.l();
                    huffman0.encode(o0, l0);
                    o o1 = l0.B1();
                    this.writeInt(o1.h0(), 0x7F, 0x80);
                    this.out.t1(o1);
                    return;
                }
            }
            this.writeInt(o0.h0(), 0x7F, 0);
            this.out.t1(o0);
        }

        public final void writeHeaders(@l List list0) throws IOException {
            int v5;
            int v4;
            ...
            while(v2 < v1) {
                ...
                o o0 = header0.name.q0();
                o o1 = header0.value;
                Hpack hpack0 = Hpack.INSTANCE;
                Integer integer0 = (Integer)hpack0.getNAME_TO_FIRST_INDEX().get(o0);
                if(integer0 == null) {
                    v5 = -1;
                }
                else {
                    ...
                    v4 = v3 + 1;
                    if(2 <= v4 && v4 < 8) {
                        if(L.g(hpack0.getSTATIC_HEADER_TABLE()[v3].value, o1)) {
                            v5 = v4;
                            goto label_31;
                        }
                        else if(L.g(hpack0.getSTATIC_HEADER_TABLE()[v4].value, o1)) {
                            v5 = v4;
                            v4 = v3 + 2;
                            goto label_31;
                        }
            ...
            label_31:
                if(v4 == -1) {
                    for(int v6 = this.nextHeaderIndex + 1; v6 < this.dynamicTable.length; ++v6) {
                        ...
                        L.m(header1);
                        if(L.g(header1.name, o0)) {
                            Header header2 = this.dynamicTable[v6];
                            L.m(header2);
                            if(L.g(header2.value, o1)) {
                ...
                if(v4 != -1) {
                    ...
                    this.out.e2(0x40);
                    this.writeByteString(o0);
                    this.writeByteString(o1);
                    this.insertIntoDynamicTable(header0);
                }
                else if(!o0.i0(Header.PSEUDO_PREFIX) || L.g(Header.TARGET_AUTHORITY, o0)) {
    ...
    @l
    public final o checkLowercase(@l o o0) throws IOException {
        L.p(o0, "name");
        int v = o0.h0();
        for(int v1 = 0; v1 < v; ++v1) {
            int v2 = o0.r(v1);
            if(65 <= v2 && v2 < 91) {
                throw new IOException("PROTOCOL_ERROR response malformed: mixed case name: " + o0.t0());
            }
        }
        return o0;
    }
    ...
    private final Map nameToFirstIndex() {
        ...
        L.o(map0, "unmodifiableMap(result)");
        return map0;
    }
}
